...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var   (data is LPSYMENTRY)
 ...
 TKT_CS_ENDIF    ,          // 22: ...                 ENDIF      ...
 TKT_CS_ENDREPEAT,          // 23: ...                 ENDREPEAT  ...
 TKT_CS_ENDSELECT,          // 24: ...                 ENDSELECT  ...
 TKT_CS_ENDWHILE ,          // 25: ...                 ENDWHILE   ...
 TKT_CS_FOR      ,          // 26: ...                 FOR        ...
 TKT_CS_FOR2     ,          // 27: ...                 FOR2       ...
 TKT_CS_GOTO     ,          // 28: ...                 GOTO       ...
 TKT_CS_IF       ,          // 29: ...                 IF         ...
 TKT_CS_IF2      ,          // 2A: ...                 IF2        ...
 TKT_CS_IN       ,          // 2B: ...                 IN         ...
 TKT_CS_LEAVE    ,          // 2C: ...                 LEAVE      ...
 TKT_CS_ORIF     ,          // 2D: ...                 ORIF       ...
 TKT_CS_REPEAT   ,          // 2E: ...                 REPEAT     ...
 TKT_CS_REPEAT2  ,          // 2F: ...                 REPEAT2    ...
 TKT_CS_RETURN   ,          // 30: ...                 RETURN     ...
 TKT_CS_SELECT   ,          // 31: ...                 SELECT     ...
 TKT_CS_SELECT2  ,          // 32: ...                 SELECT2    ...
 TKT_CS_UNTIL    ,          // 33: ...                 UNTIL      ...
 TKT_CS_WHILE    ,          // 34: ...                 WHILE      ...
 TKT_CS_WHILE2   ,          // 35: ...                 WHILE2     ...
 TKT_CS_SKIPCASE ,          // 36: ...                 Special token
 TKT_CS_SKIPEND  ,          // 37: ...                 Special token

 TKT_LENGTHp1    ,          // 38: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 38: Strand accumulating                     (data is LPTOKEN)
 TKT_LISTINT     ,          // 39: List intermediate                       (data is HGLOBAL)
 TKT_LISTPAR     ,          // 3A: List in parens                          (data is HGLOBAL)
 TKT_LSTIMMED    ,          // 3B: List in brackets, single element, immed (data is immediate)
 TKT_LSTARRAY    ,          // 3C: List in brackets, single element, array (data is HGLOBAL)
 TKT_LSTMULT     ,          // 3D: List in brackets, multiple elements     (data is HGLOBAL)
 TKT_FCNARRAY    ,          // 3E: Array of functions and/or operators     (data is HGLOBAL)
 TKT_FCNNAMED    ,          // 3F: A named function                        (data is LPSYMENTRY)
 TKT_AXISIMMED   ,          // 40: An immediate axis specification         (data is immediate)
 TKT_AXISARRAY   ,          // 41: An array of  ...                        (data is HGLOBAL)
 TKT_OP1NAMED    ,          // 42: A named monadic primitive operator      (data is LPSYMENTRY)
 TKT_OP2NAMED    ,          // 43: ...     dyadic  ...
 TKT_OP3NAMED    ,          // 44: ...     ambiguous ...
 TKT_STRNAMED    ,          // 45: A named strand
 TKT_CS_NEC      ,          // 46: Control structure:  Special token (cs_yyparse only)
 TKT_CS_EOL      ,          // 47: Control structure:  Special token (cs_yyparse only)
                            // 48-7F:  Available entries (7 bits)
} TOKEN_TYPES;
