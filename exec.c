...
////} // End IF
	...
	if (esState->exType EQ EX_IMMEX)
	{
		switch (lpwszLine[0])
		{
			...
			case UCS2_DEL:		// Function definition
#if (defined (DEBUG)) && (defined (EXEC_TRACE))
				// ***FIXME***
			...
			case UCS2_DELTILDE: // Locked function definition
#if (defined (DEBUG)) && (defined (EXEC_TRACE))
				// ***FIXME***
...

{
	...
	if ((wch EQ '/'
	  || wch EQ '\\'
	  || wch EQ UCS2_SLASHBAR
	  || wch EQ UCS2_SLOPEBAR)
...
#undef	lpHeader
		...
		switch (lpToken->tkFlags.TknType)
		{
			...
			case TKT_ASSIGN:			// Assignment symbol (data is UCS2_LEFTARROW)
			case TKT_LISTSEP:			// List separator	 (...	  ';')
			case TKT_VARIMMED:			// Immediate data (data is immediate)
			case TKT_FCNIMMED:			// Immediate primitive function (any valence) (data is UCS2_***)
			case TKT_OP1IMMED:			// ...		 Monadic primitive operator (data is UCS2_***)
			...
			case TKT_INPOUT:			// Input/Output (data is UCS2_QUAD or UCS2_QUOTEQUAD)
				break;					// Nothing to do
...
////////case 'R':                       // See below (COL_RATIONAL)
		...
		case 'Y':
		case 'Z':
		case UCS2_DELTA:				// Alt-'h' - delta
		case UCS2_DELTAUNDERBAR:		// Alt-'H' - delta-underbar
			return COL_ALPHA;
...
////////case UCS2_UNDERBAR: 			// Alt-'f' - underbar (COL_ALPHA)
		case UCS2_DEL:					// Alt-'g' - del
////////case UCS2_DELTA:				// Alt-'h' - delta (COL_ALPHA)
		case UCS2_IOTA: 				// Alt-'i' - iota
////////case UCS2_JOT:					// Alt-'j' - jot (COL_JOT)
...
////////case UCS2_QUAD: 				// Alt-'l' - quad (COL_Q_QQ)
		...
		case UCS2_RHO:					// Alt-'r' - rho
		case UCS2_UPSTILE:				// Alt-'s' - up stile
		case UCS2_TILDE:				// Alt-'t' - tilde
		case UCS2_DNARROW:				// Alt-'u' - down arrow
		case UCS2_DOWNSHOE: 			// Alt-'v' - down shoe
		case UCS2_OMEGA:				// Alt-'w' - omega
		case UCS2_RIGHTSHOE:			// Alt-'x' - right shoe
...
////////case UCS2_						// Alt-'"' - (none)
		...
		case UCS2_CIRCLESTILE:			// Alt-'%' - rotate
		case UCS2_CIRCLEBAR:			// Alt-'&' - circle-bar
		case UCS2_HYDRANT:				// Alt-'\''- execute
		case UCS2_DOWNCARETTILDE:		// Alt-'(' - nor
		case UCS2_UPCARETTILDE: 		// Alt-')' - nand
		case UCS2_CIRCLESTAR:			// Alt-'*' - log
		case UCS2_DOMINO:				// Alt-'+' - domino
////////case UCS2_LAMP: 				// Alt-',' - comment (COL_LAMP)
		case UCS2_TIMES:				// Alt-'-' - times
////////case UCS2_SLOPEBAR: 			// Alt-'.' - slope-bar (COL_PRIM_OP1)
////////case UCS2_SLASHBAR: 			// Alt-'/' - slash-bar (COL_PRIM_OP1)
		case UCS2_UPCARET:				// Alt-'0' - and (94??)
////////case UCS2_DIERESIS: 			// Alt-'1' - dieresis (COL_PRIM_OP1)
////////case UCS2_OVERBAR:				// Alt-'2' - overbar (COL_OVERBAR)
		case UCS2_LEFTCARET:			// Alt-'3' - less
		case UCS2_NOTMORE:				// Alt-'4' - not more
		case UCS2_EQUAL:				// Alt-'5' - equal
		case UCS2_NOTLESS:				// Alt-'6' - not less
		case UCS2_RIGHTCARET:			// Alt-'7' - more
		case UCS2_NOTEQUAL: 			// Alt-'8' - not equal
		case UCS2_DOWNCARET:			// Alt-'9' - or
////////case UCS2_						// Alt-':' - (none)
		case UCS2_THORN:				// Alt-';' - format
////////case UCS2_						// Alt-'<' - (none)
		case UCS2_DIVIDE:				// Alt-'=' - divide
////////case UCS2_						// Alt-'>' - (none)
////////case UCS2_						// Alt-'?' - (none)
////////case UCS2_DELTILDE: 			// Alt-'@' - del-tilde (COL_UNK)
////////case UCS2_						// Alt-'A' - (none)
////////case UCS2_						// Alt-'B' - (none)
////////case UCS2_						// Alt-'C' - (none)
...
////////case UCS2_						// Alt-'X' - (none)
////////case UCS2_						// Alt-'Y' - (none)
////////case UCS2_						// Alt-'Z' - (none)
////////case UCS2_LEFTARROW:			// Alt-'[' - left arrow (COL_ASSIGN)
...
////////case '?':                       // UCS2_QUERY
		...
		case UCS2_APOSTROPHE:			// Alt-'k' - single quote
			return COL_QUOTE1;

		case '"':                       // Double quote
			return COL_QUOTE2;

		case UCS2_QUAD: 				// Alt-'l' - quad
		case UCS2_QUOTEQUAD:			// Alt-'{' - quote-quad
			return COL_Q_QQ;
		...
		case UCS2_OVERBAR:				// Alt-'2' - high minus
			return COL_OVERBAR;

		case UCS2_DIAMOND:				// Alt-'`' - diamond
			return COL_DIAMOND;

		case UCS2_ZILDE:				// Alt-'}' - zilde
			return COL_PRIM_FN0;
