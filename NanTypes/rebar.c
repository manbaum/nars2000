...
#define H                       $LDC_LT_HORZ        // Line Drawing Character: Light Horizointal Bar
  ...
  L" " WS_UTF16_OVERBAR L"9" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" (R-+R)" $DIVIDE L"2          9"                       WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" (R++R)" $DIVIDE L"2\n"
  ...
  L" " WS_UTF16_OVERBAR L"1" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" asin  (R)         1"                                  WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" sin  (R)\n"
        ...
        {WS_UTF16_LEFTCARETUNDERBAR , {0}, L"LeftCaretUnderbar",
                                           L"Contract:                " WS_UTF16_LEFTCARETUNDERBAR L"R  or   " WS_UTF16_LEFTCARETUNDERBAR L"[X] R\n\n"
        ...
        {WS_UTF16_RIGHTCARETUNDERBAR, {0}, L"RightCaretUnderbar",
                                           L"Distract:                   " WS_UTF16_RIGHTCARETUNDERBAR L"R  or   " WS_UTF16_RIGHTCARETUNDERBAR L"[X] R\n\n"
...
////////{WS_UTF16_DELTILDE          , {0}, L""},       // ...
        ...
        {WS_UTF16_DOUBLESHRIEK      , {0}, L"DoubleShriek",
                                           ...
                                           L"010 CG" $DS L"M N:   M Combinations of N items (" $SECTION $DAGGER L")\n"
                                           L"011 CG" $DS L"M N:   M Multisets of N items (" $SECTION $DAGGER L")\n"
                                           L"012 CG" $DS L"M N:   Compositions of M into N parts (" $SECTION L"),\n"
                                           ...
                                           L"110 CG" $DS L"M N:   M Permutations of N items (" $SECTION $DBLDAGGER L")\n"
                                           L"111 CG" $DS L"M N:   M Tuples of N items (" $SECTION L")\n"
                                           L"112 CG" $DS L"M N:   Partitions of {" $IOTA L"M} into N ordered parts\n\n"
                                           $SECTION L" " $ARROWS L" supports CG=2 (Lexicographic Order)\n"
                                           $DAGGER L" " $ARROWS L" CG=3 uses Genlex order\n"
                                           $DBLDAGGER L" " $ARROWS L" CG=3 uses Gray Code order\n\n"
                                           L"Keyboard:  Alt-'k'\n\n"
        ...
        {WS_UTF16_QUADJOT           , {0}, L"QuadJot",
                                           ...
                                           L"           of shape 2" $RHO L"=S where =S returns the Hypercomplex\n"
                                           L"           dimension of S\n"
        ...
        {WS_UTF16_DOUBLETILDE       , {0}, L"DoubleTilde",
                                           L"Monadic:   " $LE $DT L"R      Convert Endpoints into Midpoint-Radius\n"
                                           L"           " $LE L"[X]" $DT L"R   ...\n"
                                           L"           " $GE $DT L"R      Convert Midpoint-Radius into Endpoints\n"
                                           L"           " $GE L"[X]" $DT L"R   ...\n"
                                           L""
                                           L""
                                           L"Dyadic:   L" $DNSH $DT L"R      Union of two Balls as a scalar function\n"
                                           L"          L" $UPSH $DT L"R      Intersection ... -- NaN (" WS_UTF16_NAN L") if empty\n"
                                           L"\n\n"
                                           L"Keyboard:  Alt-'Q'\n\n"
