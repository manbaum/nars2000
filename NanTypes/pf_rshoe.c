                ...
                case PTRTYPE_STCONST:   // Ignore (simple) scalar items
                    ...
                    switch (aplTypeRes)
                    {
                        ...
                        case ARRAY_ARB:
                            ...
                            for (uSubRest = 0; uSubRest < aplNELMComRest; uSubRest++)
                            for (uSubLast = 0; uSubLast < aplNELMComLast; uSubLast++)
                                Myarb_init (&((LPAPLARB) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)]);

                            // Save the ARB in the first position
                            // Split cases based upon the immediate storage type
                            switch (((LPAPLHETERO) lpMemRht)[uRht]->stFlags.ImmType)
                            {
                                case IMMTYPE_BOOL:
                                case IMMTYPE_INT:
                                    arb_set_sx (&((LPAPLARB)   lpMemRes)[uRht * aplNELMCom], ((LPAPLHETERO) lpMemRht)[uRht]->stData.stInteger);

                                    break;

                                case IMMTYPE_FLOAT:
                                    arb_set_d  (&((LPAPLARB)   lpMemRes)[uRht * aplNELMCom], ((LPAPLHETERO) lpMemRht)[uRht]->stData.stFloat);
...
////////////////////////////////(*aTypeFree[aplTypeRes]) (&atSub, 0);
                        ...
                        case ARRAY_ARB:
                            ...
                            for (uSubLast =        0; uSubLast < aplNELMSubLast; uSubLast++, uSub++)
                            {
                                ...
                                // Copy the converted item to the result
                                ((LPAPLARB) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)] = atSub.aplArb;
...
////////////////////////////////(*aTypeFree[aplTypeRes]) (&atSub, 0);
                        ...
                        case ARRAY_BA2F:
                            ...
                            for (uSubLast =        0; uSubLast < aplNELMSubLast; uSubLast++, uSub++)
                            {
                                ...
                                // Copy the converted item to the result
                                ((LPAPLBA2F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)] = atSub.aplBA2F;
...
////////////////////////////////(*aTypeFree[aplTypeRes]) (&atSub, 0);
                            ...
                            for (uSubLast = aplNELMSubLast; uSubLast < aplNELMComLast; uSubLast++)
                            {
                                ...
                                // Loop through all of the parts
                                for (i = 0; i < 2; i++)
                                    Myarb_init (&((LPAPLBA2F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)].parts[i]);
                            } // End FOR/FOR
                        ...
                        case ARRAY_BA4F:
                            ...
                            for (uSubLast =        0; uSubLast < aplNELMSubLast; uSubLast++, uSub++)
                            {
                                ...
                                // Copy the converted item to the result
                                ((LPAPLBA4F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)] = atSub.aplBA4F;
...
////////////////////////////////(*aTypeFree[aplTypeRes]) (&atSub, 0);
                            ...
                            for (uSubLast = aplNELMSubLast; uSubLast < aplNELMComLast; uSubLast++)
                            {
                                ...
                                // Loop through all of the parts
                                for (i = 0; i < 4; i++)
                                    Myarb_init (&((LPAPLBA4F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)].parts[i]);
                            } // End FOR/FOR
                        ...
                        case ARRAY_BA8F:
                            ...
                            for (uSubLast =        0; uSubLast < aplNELMSubLast; uSubLast++, uSub++)
                            {
                                ...
                                // Copy the converted item to the result
                                ((LPAPLBA8F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)] = atSub.aplBA8F;
...
////////////////////////////////(*aTypeFree[aplTypeRes]) (&atSub, 0);
                            ...
                            for (uSubLast = aplNELMSubLast; uSubLast < aplNELMComLast; uSubLast++)
                            {
                                ...
                                // Loop through all of the parts
                                for (i = 0; i < 8; i++)
                                    Myarb_init (&((LPAPLBA8F) lpMemRes)[(uRht * aplNELMCom) + uSubLast + (uSubRest * aplNELMComLast)].parts[i]);
                            } // End FOR/FOR
...
#undef  lpAPA
                        ...
                        case ARRAY_BA8F:
                            ...
                            switch (aplTypeSub)
                            {
                                ...
                                case ARRAY_ARB:
                                    // Initialize the temp to 0
                                    Myarb_init (&atSub.aplArb);

                                    break;

                                case ARRAY_BA2F:
                                    // Initialize the temp to 0
                                    arb2f_init (&atSub.aplBA2F);

                                    break;

                                case ARRAY_BA4F:
                                    // Initialize the temp to 0
                                    arb4f_init (&atSub.aplBA4F);

                                    break;

                                case ARRAY_BA8F:
                                    // Initialize the temp to 0
                                    arb8f_init (&atSub.aplBA8F);
             ...
             && uLft EQ (aplNELMNstLft - 1))
            {
                ...
                switch (aplTypeRht)
                {
                    ...
                    case ARRAY_BA8F:
                        ...
                        for (i = 0; i < iHCDimRht; i++)
                            // Set the new value freeing the old one
                            arb_set (&((LPAPLARB) lpMemRht)[i + iHCDimRht * aplLongestSubLft], &atRht.aplBA8F.parts[i]);
