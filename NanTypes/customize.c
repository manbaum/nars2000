...
#define KTC_TXT_CY     15           // # rows ...

WCHAR awKTC_APL[KTC_TXT_CY][KTC_TXT_CX]
= {{UTF16_UPCARET       , UTF16_DOWNCARET       , UTF16_UPCARETTILDE    , UTF16_DOWNCARETTILDE   , UTF16_TILDE            , UTF16_ZILDE             },  // 00
   {UTF16_DELTASTILE    , UTF16_DELSTILE        , UTF16_DELTA           , UTF16_DEL              , UTF16_DELTAUNDERBAR    , UTF16_DIERESISDEL       },  // 01
   {UTF16_QUAD          , UTF16_QUOTEQUAD       , UTF16_SQUAD           , UTF16_DOMINO           , UTF16_COLONBAR         , UTF16_TIMES             },  // 02
   {UTF16_UPARROW       , UTF16_DOWNARROW       , UTF16_UPDOWNARROWS    , UTF16_LEFTARROW        , UTF16_RIGHTARROW       , UTF16_LEFTRIGHTARROWS   },  // 03
   {UTF16_UPTACK        , UTF16_DOWNTACK        , UTF16_LEFTTACK        , UTF16_RIGHTTACK        , UTF16_UPTACKJOT        , UTF16_DOWNTACKJOT       },  // 04
   {UTF16_JOT           , UTF16_DIERESISJOT     , UTF16_DIERESISDOWNTACK, UTF16_DIERESISSTAR     , UTF16_DIERESIS         , UTF16_VARIANT           },  // 05
   {UTF16_UPSTILE       , UTF16_DOWNSTILE       , UTF16_STILE           , UTF16_STILETILDE       , UTF16_DOWNSHOESTILE    , UTF16_PI                },  // 06
   {UTF16_LEFTSHOE      , UTF16_RIGHTSHOE       , UTF16_LEFTSHOEUNDERBAR, UTF16_RIGHTSHOEUNDERBAR, UTF16_UPSHOE           , UTF16_DOWNSHOE          },  // 07
   {UTF16_IOTA          , UTF16_IOTAUNDERBAR    , UTF16_EPSILON         , UTF16_EPSILONUNDERBAR  , UTF16_RHO              , UTF16_ROOT              },  // 08
   {UTF16_CIRCLE        , UTF16_CIRCLESTILE     , UTF16_CIRCLEBAR       , UTF16_CIRCLESLOPE      , UTF16_CIRCLESTAR       , UTF16_DIERESISCIRCLE    },  // 09
   {UTF16_SLASH         , UTF16_SLASHBAR        , UTF16_SLOPE           , UTF16_SLOPEBAR         , UTF16_NOTEQUAL         , UTF16_SECTION           },  // 0A
   {UTF16_EQUALUNDERBAR , UTF16_NOTEQUALUNDERBAR, UTF16_ALPHA           , UTF16_OMEGA            , UTF16_LEFTCARETUNDERBAR, UTF16_RIGHTCARETUNDERBAR},  // 0B
   {UTF16_DIAMOND       , UTF16_COMMABAR        , UTF16_OVERBAR         , UTF16_LAMP             , UTF16_INFINITY         , UTF16_CIRCLEMIDDLEDOT   },  // 0C
   {UTF16_DELTILDE      , UTF16_NAN             , UTF16_DOUBLESHRIEK    , UTF16_QUADJOT          , UTF16_DERIV            , UTF16_POM               },  // 0D
   {UTF16_DOUBLETILDE   , 0                     , 0                     , 0                      , 0                      , 0                       },  // 0E
  };
...
////////////////////    break;
                    ...
                    case IDD_PROPPAGE_USER_PREFS:                       // MYWM_INITDIALOG
                        ...
                        CheckDlgButton (hWndProp, IDC_USER_PREFS_XB_RADCTLMIDPREC      , OptionFlags.bRadCtlMidPrec      );
...
////////////////////} // End IF
                    ...
                    if (custStruc[uCnt].bInitialized)
                    {
                        ...
                        OptionFlags.bRadCtlMidPrec       = IsDlgButtonChecked (hWndProp, IDC_USER_PREFS_XB_RADCTLMIDPREC      );
...
////////////////////////////////cc.lpTemplateName = NULL;                   // Already zero from = {0}
                ...
                case IDC_USER_PREFS_XB_RADCTLMIDPREC:
                    // We care about BN_CLICKED only
                    if (BN_CLICKED EQ cmdCtl)
                        // Enable the Apply button
                        EnableWindow (hWndApply, TRUE);
...
//
//  Local []FEATURE name ComboLbox subclass procedure
//***************************************************************************
