...
typedef enum tagEXCEPTION_CODES // Exception Codes
{
    ...
    EXCEPTION_RESULT_ARB         = MAKE_ERRCODE (0x12)  ,   // 12:  ...              ARB
    EXCEPTION_RESULT_BA2F        = MAKE_ERRCODE (0x13)  ,   // 13:  ...              BA2F
    EXCEPTION_RESULT_BA4F        = MAKE_ERRCODE (0x14)  ,   // 14:  ...              BA4F
    EXCEPTION_RESULT_BA8F        = MAKE_ERRCODE (0x15)  ,   // 15:  ...              BA8F

    EXCEPTION_ERRMSG_ALREADY_SET = MAKE_ERRCODE (0x16)  ,   // 16:  Look in lpMemPTD->lpwszErrorMessage
