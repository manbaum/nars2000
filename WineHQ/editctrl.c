...
//#endif
    ...
    case EM_SETPAINTHOOK:
        result = GetWindowLongW (hwnd, GWLEC_PAINTHOOK);
...
static void EDIT_LockBuffer(EDITSTATE *es)
{
    ...
    HINSTANCE16 hInstance = (HINSTANCE16) GetWindowLongPtrW( es->hwndSelf, GWLP_HINSTANCE );
#endif
...
//  TRACE("Allocating 16-bit ANSI alias buffer\n");
    if (!(es->hloc16 = LocalAlloc16(LMEM_MOVEABLE | LMEM_ZEROINIT, (WORD) alloc_size))) {
