...
// The alphabet, unshifted
  ...
  {UTF16_POM                  , L"{plusorminus}"        },  // Alt-'q' - Plus or minus symbol
  {UTF16_POM                  , L"{pom}"                },  // ...
...
//{UTF16_                     ,                         },  // Alt-'K' - (none)
  ...
  {UTF16_DOUBLETILDE          , L"{doubletilde}"        },  // Alt-'Q' - Arbitrary Precision  (doubletilde)
...
// Non-Alt key equivalents (these are the only ones we need for SaveWS)
  ...
  {UTF16_QUERY                , L"{query}"              },  // 003F:  Question-mark
