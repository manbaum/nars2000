...
#define ALLOC_GPTR
  ...
  #define MyGlobalLockNfns(a)             ValidObj (ClrPtrTypeDir (a), NFNS_HEADER_SIGNATURE)       // _MyGlobalLockNfns (ClrPtrTypeDir (a), FNLN)
  ...
  #define MyGlobalLockNfns(a)             _MyGlobalLock (ValidObj (ClrPtrTypeDir (a), NFNS_HEADER_SIGNATURE     ), FNLN)
  ...
  #define MyGlobalLockNfns(a)             ValidObj (ClrPtrTypeDir (a), NFNS_HEADER_SIGNATURE     )  // GlobalLock (a)
  ...
  #define MyGlobalLockNfns(a)             GlobalLock (ValidObj (ClrPtrTypeDir (a), NFNS_HEADER_SIGNATURE        ))
  ...
  #define MyGlobalFlags(a)                GlobalFlags(C lrPtrTypeDir (a))
