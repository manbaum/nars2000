...
#undef  lpHeader
    ...
    for (uOutRht = 0; uOutRht < aplRestRht; uOutRht++)
    {
        ...
        switch (aplTypeRes)
        {
            ...
            case ARRAY_ARB:
                // Initialize accumulator and weighting value
                arb1f_init (&atAcc.aplArb);
                arb1f_init (&atVal.aplArb);
                arb_set_sx  (&atVal.aplArb, 1);
...
////////////////ZeroMemory (&atVal, sizeof (atVal));        // ...
            ...
            case ARRAY_BA2F:
                // Initialize accumulator and weighting value
                arb2f_init (&atAcc.aplBA2F);
                arb2f_init (&atVal.aplBA2F);
                arb_set_sx (&atVal.aplArb, 1);
            ...
            case ARRAY_BA4F:
                // Initialize accumulator and weighting value
                arb4f_init (&atAcc.aplBA4F);
                arb4f_init (&atVal.aplBA4F);
                arb_set_sx (&atVal.aplArb, 1);
        ...
        for (iInnMax = aplInnrMax - 1; iInnMax >= 0; iInnMax--)
        {
            ...
            switch (aplTypeRes)
            {
                ...
                case ARRAY_RAT:
                    // Add into accumulator
////////////////////atAcc.aplRat += atVal.aplRat * GetNextRat_INIT (lpMemRht, aplTypeRht, uInnRht);
...
////////////////////atVal.aplVfp *= atLft.aplVfp;
                ...
                case ARRAY_ARB:
                    // Add into accumulator
////////////////////atAcc.aplArb += atVal.aplArb * atRht.aplArb;
////////////////////arb_mul (&atAdd.aplArb, &atVal.aplArb, &atRht.aplArb, prec);
                    atAdd.aplArb = MulBA1F_RE (atVal.aplArb, atRht.aplArb);
                    arb_add (&atAcc.aplArb, &atAcc.aplArb, &atAdd.aplArb, prec);

                    // Free old atAdd
                    (*aTypeFree[aplTypeRes]) (&atAdd, 0);

                    // Multiply into the weighting value
////////////////////atVal.aplArb *= atLft.aplArb;
                    arb_mul (&atVal.aplArb, &atVal.aplArb, &atLft.aplArb, prec);
...
////                break;
                ...
                case ARRAY_BA2F:
                    // Add into accumulator
////////////////////atAcc.aplBAxF += atRht.aplBAxF * atVal.aplBAxF;
////////////////////atAcc.aplBA2F = AddBA2F_RE (atAcc.aplBA2F,
////////////////////                            MulBA2F_RE (atRht.aplBA2F,
////////////////////                                        atVal.aplBA2F));
                    atMul.aplBA2F = MulBA2F_RE (atRht.aplBA2F,
                                                atVal.aplBA2F);
                    atAdd.aplBA2F = AddBA2F_RE (atAcc.aplBA2F,
                                                atMul.aplBA2F);
                    arb2f_set (&atAcc.aplBA2F, &atAdd.aplBA2F);
                    ...
                    // Multiply into the weighting value on the left
////////////////////atVal.aplBAxF = atLft.aplBAxF * atVal.aplBAxF;
////////////////////atVal.aplBA2F = MulBA2F_RE (atLft.aplBA2F,
////////////////////                            atVal.aplBA2F);
                    atMul.aplBA2F = MulBA2F_RE (atLft.aplBA2F,
                                                atVal.aplBA2F);
                    arb2f_set (&atVal.aplBA2F, &atMul.aplBA2F);
                ...
                case ARRAY_BA4F:
                    // Add into accumulator
////////////////////atAcc.aplBAxF += atRht.aplBAxF * atVal.aplBAxF;
////////////////////atAcc.aplBA4F = AddBA4F_RE (atAcc.aplBA4F,
////////////////////                            MulBA4F_RE (atRht.aplBA4F,
////////////////////                                        atVal.aplBA4F));
                    atMul.aplBA4F = MulBA4F_RE (atRht.aplBA4F,
                                                atVal.aplBA4F);
                    atAdd.aplBA4F = AddBA4F_RE (atAcc.aplBA4F,
                                                atMul.aplBA4F);
                    arb4f_set (&atAcc.aplBA4F, &atAdd.aplBA4F);
                    ...
                    // Multiply into the weighting value on the left
////////////////////atVal.aplBAxF = atLft.aplBAxF * atVal.aplBAxF;
////////////////////atVal.aplBA4F = MulBA4F_RE (atLft.aplBA4F,
////////////////////                            atVal.aplBA4F);
                    atMul.aplBA4F = MulBA4F_RE (atLft.aplBA4F,
                                                atVal.aplBA4F);
                    arb4f_set (&atVal.aplBA4F, &atMul.aplBA4F);
...
////                // Add into accumulator
////////////////////atAcc.aplBAxF += atRht.aplBAxF * atVal.aplBAxF;
////////////////////atAcc.aplBA8F = AddBA8F_RE (atAcc.aplBA8F,
////////////////////                            MulBA8F_RE (atRht.aplBA8F,
////////////////////                                        atVal.aplBA8F));
////                atMul.aplBA8F = MulBA8F_RE (atRht.aplBA8F,
////                                            atVal.aplBA8F);
////                atAdd.aplBA8F = AddBA8F_RE (atAcc.aplBA8F,
////                                            atMul.aplBA8F);
////                arb8f_set (&atAcc.aplBA8F, &atAdd.aplBA8F);
////
////                // Free old atAdd and atMul
////                (*aTypeFree[aplTypeRes]) (&atAdd, 0);
////                (*aTypeFree[aplTypeRes]) (&atMul, 0);
...
////                // Multiply into the weighting value on the left
////////////////////atVal.aplBAxF = atLft.aplBAxF * atVal.aplBAxF;
////////////////////atVal.aplBA8F = MulBA8F_RE (atLft.aplBA8F,
////////////////////                            atVal.aplBA8F);
////                atMul.aplBA8F = MulBA8F_RE (atLft.aplBA8F,
////                                            atVal.aplBA8F);
////                arb8f_set (&atVal.aplBA8F, &atMul.aplBA8F);
////
////                // Free old atMul
////                (*aTypeFree[aplTypeRes]) (&atMul, 0);
////
////                break;
        ...
        switch (aplTypeRes)
        {
            ...
            case ARRAY_ARB:
                // Save in the result
                arb_init_set (&((LPAPLARB) lpMemRes)[uRes], &atAcc.aplArb);
...
////        case ARRAY_BA8F:
                ...
                for (i = 0; i < iHCDimRes; i++)
                    // Save in the result
                    arb_init_set (((LPAPLARB) lpMemRes)++, &atAcc.aplBA8F.parts[i]);
                break;
