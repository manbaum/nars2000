...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 TKT_LINECONT ,             // 13: Line continuation (data is NULL)
 TKT_INPOUT   ,             // 14: Input/Output (data is UTF16_QUAD or UTF16_QUOTEQUAD symbol)

 TKT_LENGTHp1 ,             // 15: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 15: Strand accumulating (data is LPTOKEN)
 TKT_LISTINT  ,             // 16: List intermediate (data is HGLOBAL)
 TKT_LISTPAR  ,             // 17: List in parens    (data is HGLOBAL)
 TKT_LISTBR   ,             // 18: List in brackets  (data is HGLOBAL)
 TKT_VARARRAY ,             // 19: Array of data (data is HGLOBAL)
 TKT_FCNARRAY ,             // 1A: Array of functions and/or operators (data is HGLOBAL)
 TKT_FCNNAMED ,             // 1B: A named function (data is LPSYMENTRY)
 TKT_AXISIMMED,             // 1C: An immediate axis specification (data is immediate)
 TKT_AXISARRAY,             // 1D: An array of  ...   (data is HGLOBAL)
 TKT_OP1NAMED ,             // 1E: A named monadic primitive operator (data is LPSYMENTRY)
 TKT_OP2NAMED ,             // 1F: ...     dyadic  ...
 TKT_OP3NAMED ,             // 20: ...     ambiguous ...
 TKT_STRNAMED ,             // 21: A named strand
                            // 22-3F:  Available entries (6 bits)
} TOKEN_TYPES;
