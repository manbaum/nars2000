...
PRIMSPEC PrimSpecLeftCaret = {
    ...
    NULL,   // &PrimFnMonLeftCaretBA1FisBA1F,
    NULL,   // &PrimFnMonLeftCaretBA2FisBA2F,
    NULL,   // &PrimFnMonLeftCaretBA4FisBA4F,
    NULL,   // &PrimFnMonLeftCaretBA8FisBA8F,
    NULL,   // &PrimFnMonLeftCaretARBisBA1F,
    NULL,   // &PrimFnMonLeftCaretARBisBA2F,
    NULL,   // &PrimFnMonLeftCaretARBisBA4F,
    NULL,   // &PrimFnMonLeftCaretARBisBA8F,
    ...
    &PrimFnDydLeftCaretBisARBvARB,
    NULL,   // &PrimFnDydLeftCaretBisBA2FvBA2F, -- Can't happen w/LeftCaret
    NULL,   // &PrimFnDydLeftCaretBisBA4FvBA4F, -- Can't happen w/LeftCaret
    NULL,   // &PrimFnDydLeftCaretBisBA8FvBA8F, -- Can't happen w/LeftCaret
    ...
    NULL,   // &PrimFnDydLeftCaretBA1FisBA1FvBA1F, -- Can't happen w/LeftCaret
    NULL,   // &PrimFnDydLeftCaretBA2FisBA2FvBA2F, -- Can't happen w/LeftCaret
    NULL,   // &PrimFnDydLeftCaretBA4FisBA4FvBA4F, -- Can't happen w/LeftCaret
    NULL,   // &PrimFnDydLeftCaretBA8FisBA8FvBA8F, -- Can't happen w/LeftCaret
...
//  $PrimFnDydLeftCaretBisARBvARB
//
//  Primitive scalar function dyadic LeftCaret:  B {is} ARB fn ARB
//***************************************************************************

void PrimFnDydLeftCaretBisARBvARB
    (LPAPLBOOL  lpMemRes,           // Ptr to the result
     APLUINT    uRes,               // Index into the result
     LPALLTYPES lpatLft,            // Ptr to left arg ALLTYPES
     LPALLTYPES lpatRht,            // ...    right ...
...

{
    ...
    lpMemRes[uRes >> LOG2NBIB] |=
      CmpCT_B (lpatLft->aplArb, lpatRht->aplArb, GetQuadCT (), <)
       << (MASKLOG2NBIB & (UINT) uRes);
} // End PrimFnDydLeftCaretBisARBvARB
