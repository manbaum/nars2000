...
typedef APLARB   (*LPAPLARB2)[2][2];
typedef APLARB   (*LPAPLARB4)[4][4];
typedef APLARB   (*LPAPLARB8)[8][8];
    ...
    {                                                                               \
        ...
        {                                                                           \
            APLARB l;                                                               \
                                                                                    \
            k = MatRep##NLR[i][j];                                                  \
            l = ((LPAPLARB) lpMemRht)[abs (k)];                                     \
                                                                                    \
            /* If the sign is non-negative, ... */                                  \
            if (signum (k) >= 0)                                                    \
                arb_init_set (&(*(LPAPLARB##N) lpMemRes)[i][j], &l);                \
            else                                                                    \
            {                                                                       \
                arb_neg (&lNeg, &l);                                                \
                arb_init_set (&(*(LPAPLARB##N) lpMemRes)[i][j], &lNeg);             \
            } /* End IF/ELSE */                                                     \
        } /* End FOR/FOR */                                                         \
                                                                                    \
        /* We no longer need this storage */                                        \
