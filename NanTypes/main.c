...
////////////////    return FALSE;   // We handled the msg
  ...
  #undef  idCtl
        ...
        case WM_CLOSE:
        {
            ...
            if (EnumChildWindows (hWnd, EnumCallbackQueryClose, (LPARAM) &uCount))
            {
                // If we saved a function, ...
                if (uCount NE 0)
                ...
                return FALSE;           // Not OK to terminate/we handled the msg
        } // End WM_QUERYENDSESSION/WM_CLOSE
...
UBOOL CALLBACK EnumCallbackQueryClose
    (HWND   hWnd,           // Handle to child window
     LPARAM lParam)         // Application-defined value (may be NULL)

{
    ...
    return (UINT) SendMessageW (hWnd, WM_QUERYENDSESSION, 0, lParam);
