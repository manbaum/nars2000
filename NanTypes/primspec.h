...
typedef struct tagPRIMSPEC
{
    ...
    ATISAT             *BA1FisBA1F;         // Monadic BA1F {is} BA1F
    ATISAT             *BA2FisBA2F;         // ...       2         2
    ATISAT             *BA4FisBA4F;         // ...       4         4
    ATISAT             *BA8FisBA8F;         // ...       8         8
    ATISAT             * ARBisBA1F;         // ...       1         1
    ATISAT             * ARBisBA2F;         // ...       1         2
    ATISAT             * ARBisBA4F;         // ...       1         4
    ATISAT             * ARBisBA8F;         // ...       1         8
    ...
    ATISATVAT          *BisBA1FvBA1F;       // ...           BA1F v BA1F
    ATISATVAT          *BisBA2FvBA2F;       // ...           BA2F v BA2F
    ATISATVAT          *BisBA4FvBA4F;       // ...           BA4F v BA4F
    ATISATVAT          *BisBA8FvBA8F;       // ...           BA8F v BA8F
    ...
    ATISATVAT          *BA1FisBA1FvBA1F;    // Dyadic 1F {is}  BA1F  vs  BA1F
    ATISATVAT          *BA2FisBA2FvBA2F;    // ...    2          2         2
    ATISATVAT          *BA4FisBA4FvBA4F;    // ...    4          4         4
    ATISATVAT          *BA8FisBA8FvBA8F;    // ...    8          8         8
    ...
    UINT                bMonDimDemote:1,    // 00000001:  Allow dimension demotion for monadic scalar function
                        ...
                        iHCDimIndexLft:2,   // 000000C0:  Left arg HC Dimension Index (0, 1, 2, 3)
                        iHCDimIndexRht:2,   // 00000300:  Right ...
                        :22;                // FFFFFC00:  Available bits
} PRIMSPEC, *LPPRIMSPEC;
