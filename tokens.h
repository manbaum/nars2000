...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 TKT_FCNIMMED ,             // 07: An immediate primitive function (data is UTF16_***)
 TKT_OP1IMMED ,             // 08: An immediate monadic primitive operator (data is UTF16_***)
 TKT_OP2IMMED ,             // 09: ...          dyadic  ...
 TKT_OPJOTDOT ,             // 0A: Outer product monadic operator (with right scope) (data is NULL)
 TKT_LPAREN   ,             // 0B: Left paren (data is TKT_LPAREN)
 TKT_RPAREN   ,             // 0C: Right ...   ...         RPAREN
 TKT_LBRACKET ,             // 0D: Left bracket ...        LBRACKET
 TKT_RBRACKET ,             // 0E: Right ...   ...         RBRACKET
 TKT_EOS      ,             // 0F: End-of-Stmt (data is length of stmt including this token)
 TKT_EOL      ,             // 10: End-of-Line  ...
 TKT_LINECONT ,             // 11: Line continuation (data is NULL)
 TKT_INPOUT   ,             // 12: Input/Output (data is UTF16_QUAD or UTF16_QUOTEQUAD symbol)

 TKT_LENGTHp1 ,             // 13: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 13: Strand accumulating (data is LPTOKEN)
 TKT_LISTINT  ,             // 14: List intermediate (data is HGLOBAL)
 TKT_LISTPAR  ,             // 15: List in parens    (data is HGLOBAL)
 TKT_LISTBR   ,             // 16: List in brackets  (data is HGLOBAL)
 TKT_VARARRAY ,             // 17: Array of data (data is HGLOBAL)
 TKT_FCNARRAY ,             // 18: Array of functions or monadic operators (data is HGLOBAL)
 TKT_FCNNAMED ,             // 19: Symbol table entry for a named function (data is LPSYMENTRY)
 TKT_AXISIMMED,             // 1A: An immediate axis specification (data is immediate)
 TKT_AXISARRAY,             // 1B: An array of  ...   (data is HGLOBAL)
 TKT_OP1NAMED ,             // 1C: A named monadic primitive operator (data is LPSYMENTRY)
 TKT_OP2NAMED ,             // 1D: ...     dyadic  ...
 TKT_STRNAMED ,             // 1E: A named strand
} TOKEN_TYPES;
