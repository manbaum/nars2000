...
#define arb1f_0     conbaof_0.parts[0]
#define arb2f_0     conbaof_0.partsLo.partsLo
#define arb4f_0     conbaof_0.partsLo
#define arb8f_0     conbaof_0

#define arb1f_1     conbaof_1.parts[0]
#define arb2f_1     conbaof_1.partsLo.partsLo
#define arb4f_1     conbaof_1.partsLo
#define arb8f_1     conbaof_1

#define arb1f_N1    conbaof_N1.parts[0]
#define arb2f_N1    conbaof_N1.partsLo.partsLo
#define arb4f_N1    conbaof_N1.partsLo
#define arb8f_N1    conbaof_N1
...
typedef LPAPLCHAR (*HCB_FCN) (LPWCHAR, LPVOID, APLUINT);
...
ENUM_HCFI aArrayTypeToHCDimIndex[ARRAY_LENGTH]
 ...
 = {
    ...
    ENUM_HCFI1,     // ARRAY_BA1F
    ENUM_HCFI2,     // ARRAY_BA2F
    ENUM_HCFI4,     // ARRAY_BA4F
    ENUM_HCFI8,     // ARRAY_BA8F
}
#endif
;
...
// Conversion table from uHCDimIndex to ARB ARRAY_TYPE
EXTERN
ARRAY_TYPES uBAxF[4]
#ifdef DEFINE_VALUES
 = {ARRAY_BA1F,
...
LPAPLCHAR FormatAplArb    (LPWCHAR, LPVOID, APLUINT);
LPAPLCHAR FormatAplBA2F   (LPWCHAR, LPVOID, APLUINT);
LPAPLCHAR FormatAplBA4F   (LPWCHAR, LPVOID, APLUINT);
LPAPLCHAR FormatAplBA8F   (LPWCHAR, LPVOID, APLUINT);
...
#endif
;
HCB_FCN hcBFcn[ENUM_HCFI_LENGTH]
#ifdef DEFINE_VALUES
= {FormatAplArb, FormatAplBA2F, FormatAplBA4F, FormatAplBA8F}
#endif
;
