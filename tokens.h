...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var   (data is LPSYMENTRY)
 ...
 TKT_COMMENT     ,          // 05: Comment                              (data is NULL)
 ...
 TKT_CS_ANDIF    ,          // 1B: Control Structure:  ANDIF            (Data is Line/Stmt #)
 TKT_CS_CASE     ,          // 1C: ...                 CASE       ...
 TKT_CS_CASELIST ,          // 1D: ...                 CASELIST   ...
 TKT_CS_CONTINUE ,          // 1E: ...                 CONTINUE   ...
 TKT_CS_ELSE     ,          // 1F: ...                 ELSE       ...
 TKT_CS_ELSEIF   ,          // 20: ...                 ELSEIF     ...
 TKT_CS_END      ,          // 21: ...                 END        ...
 TKT_CS_ENDFOR   ,          // 22: ...                 ENDFOR     ...
 ...
 TKT_CS_IF2      ,          // 2B: ...                 IF2        ...
 TKT_CS_IN       ,          // 2C: ...                 IN         ...
 TKT_CS_LEAVE    ,          // 2D: ...                 LEAVE      ...
 TKT_CS_ORIF     ,          // 2E: ...                 ORIF       ...
 TKT_CS_REPEAT   ,          // 2F: ...                 REPEAT     ...
 TKT_CS_REPEAT2  ,          // 30: ...                 REPEAT2    ...
 TKT_CS_RETURN   ,          // 31: ...                 RETURN     ...
 TKT_CS_SELECT   ,          // 32: ...                 SELECT     ...
 TKT_CS_SELECT2  ,          // 33: ...                 SELECT2    ...
 TKT_CS_UNTIL    ,          // 34: ...                 UNTIL      ...
 TKT_CS_WHILE    ,          // 35: ...                 WHILE      ...
 TKT_CS_WHILE2   ,          // 36: ...                 WHILE2     ...
 TKT_CS_SKIPCASE ,          // 37: ...                 Special token
 TKT_CS_SKIPEND  ,          // 38: ...                 Special token

 TKT_LENGTHp1    ,          // 39: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 39: Strand accumulating                     (data is LPTOKEN)
 TKT_LISTINT     ,          // 3A: List intermediate                       (data is HGLOBAL)
 TKT_LISTPAR     ,          // 3B: List in parens                          (data is HGLOBAL)
 TKT_LSTIMMED    ,          // 3C: List in brackets, single element, immed (data is immediate)
 TKT_LSTARRAY    ,          // 3D: List in brackets, single element, array (data is HGLOBAL)
 TKT_LSTMULT     ,          // 3E: List in brackets, multiple elements     (data is HGLOBAL)
 TKT_FCNARRAY    ,          // 3F: Array of functions and/or operators     (data is HGLOBAL)
 TKT_FCNNAMED    ,          // 40: A named function                        (data is LPSYMENTRY)
 TKT_AXISIMMED   ,          // 41: An immediate axis specification         (data is immediate)
 TKT_AXISARRAY   ,          // 42: An array of  ...                        (data is HGLOBAL)
 TKT_OP1NAMED    ,          // 43: A named monadic primitive operator      (data is LPSYMENTRY)
 TKT_OP2NAMED    ,          // 44: ...     dyadic  ...
 TKT_OP3NAMED    ,          // 45: ...     ambiguous ...
 TKT_STRNAMED    ,          // 46: A named strand
 TKT_CS_NEC      ,          // 47: Control structure:  Special token (cs_yyparse only)
 TKT_CS_EOL      ,          // 48: Control structure:  Special token (cs_yyparse only)
                            // 49-7F:  Available entries (7 bits)
} TOKEN_TYPES;
