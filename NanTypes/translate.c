...

{
    ...
    if (lstrcmpiW (lpMemChar, L"ARB" ) EQ 0)
        return ARRAY_ARB;
    else
    if (lstrcmpiW (lpMemChar, L"BA1F") EQ 0)
        return ARRAY_BA1F;
    else
    if (lstrcmpiW (lpMemChar, L"BA2F") EQ 0)
        return ARRAY_BA2F;
    else
    if (lstrcmpiW (lpMemChar, L"BA4F") EQ 0)
        return ARRAY_BA4F;
    else
    if (lstrcmpiW (lpMemChar, L"BA8F") EQ 0)
        return ARRAY_BA8F;
    else
        return ARRAY_ERROR;
