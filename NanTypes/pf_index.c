                    ...
                    if (lpYYItm NE NULL)
                    {
                        ...
                        switch (aplTypeRes)
                        {
                            ...
                            case ARRAY_BA8F:
                                ...
                                for (i = 0; i < iHCDimRes; i++)
                                    // Save the value in the result
                                    arb_init_set (((LPAPLARB) lpMemRes)++, &((LPAPLBA8F) lpSymTmp)->parts[i]);
...

{
    ...
    switch (aplTypeLst)
    {
        ...
        case ARRAY_ARB:                 // ...                           VFP
        case ARRAY_BA2F:                // ...                           HC2V
        case ARRAY_BA4F:                // ...                           HC4V
        case ARRAY_BA8F:                // ...                           HC8V
    ...
    switch (aplTypeRes)
    {
        ...
        case ARRAY_BA8F:
            ...
            if (IsImmGlbNum (immTypeSub))
            {
                ...
                for (i = 0; i < iHCDimRes; i++)
                    // Copy the global numeric value to the result
                    arb_init_set (((LPAPLARB) lpMemRes)++, &((LPAPLBA8F) lpSymGlbSub)->parts[i]);
            } else
            {
                Assert (GetPtrTypeDir (lpSymGlbSub) EQ PTRTYPE_HGLOBAL);
                ...
                for (i = 0; i < iHCDimRes; i++)
                    // Copy the global numeric value to the result
                    arb_init_set (((LPAPLARB) lpMemRes)++, &((LPAPLBA8F) lpMemSub)->parts[i]);
...
#undef  lpMemLst2
    ...
    switch (aplTypeRht)
    {
        ...
        case ARRAY_BA8F:
            ...
            if (!IsSingleton (aplNELMRht))
                // Point to the last item in the right arg
                lpMemRht = &((LPAPLARB   ) lpMemRht)[iHCDimRht * (aplNELMRht - 1)];
            break;
    ...
    if (hGlbSubLst EQ NULL)
    {
        ...
        switch (aplTypeRes)
        {
            ...
            case ARRAY_HC8R:
                ...
                for (i = 0; i < iHCDimNam; i++)
                    // Save in the result
                    mpq_set (&((LPAPLRAT)   lpMemNam)[i + iHCDimNam * aplLongestSubLst], &atRht.aplHC8R.parts[i]);
            ...
            case ARRAY_HC8V:
                ...
                for (i = 0; i < iHCDimNam; i++)
                    // Save in the result
                    mpfr_copy (&((LPAPLVFP) lpMemNam)[i + iHCDimNam * aplLongestSubLst], &atRht.aplHC8V.parts[i]);
            ...
            case ARRAY_BA8F:
                ...
                for (i = 0; i < iHCDimNam; i++)
                    // Save in the result
                    arb_set (&((LPAPLARB) lpMemNam)[i + iHCDimNam * aplLongestSubLst], &atRht.aplBA8F.parts[i]);
...
////////////(*aTypeFree[aplTypeRes]) (&atRes, 0);
        ...
        case ARRAY_BA8F:
            ...
            for (i = 0; i < iHCDimRes; i++)
                // Save in the result
                ((LPAPLARB  ) lpMemRes)[i + iHCDimRes * aplLongestSubLst] = atRes.aplBA8F.parts[i];
////////////// No need to free as we copy the value to the result
////////////(*aTypeFree[aplTypeRes]) (&atRes, 0);
...
////////////(*aTypeFree[aplTypeRes]) (&atRes, 0);
        ...
        case ARRAY_BA8F:
            ...
            for (i = 0; i < iHCDimRht; i++)
                // Save the result in the right arg
                ((LPAPLARB)   lpMemRht)[i + iHCDimRht * aplIndex] = atSet.aplBA8F.parts[i];
////////////// No need to free as we copy the value to the result
////////////(*aTypeFree[aplTypeRes]) (&atRes, 0);
