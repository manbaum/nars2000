...
typedef struct tagFORSTMT           // FOR stmt struc
{
...
typedef struct tagCS_YYSTYPE        // YYSTYPE for Function Header parser
{
...
typedef struct tagCSLOCALVARS       // Function Header Local Vars
{
