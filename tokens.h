...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 TKT_OP3IMMED ,             // 0B: ...          ambiguous  ...
 TKT_OPJOTDOT ,             // 0C: Outer product monadic operator (with right scope) (data is NULL)
 TKT_LPAREN   ,             // 0D: Left paren (data is TKT_LPAREN)
 TKT_RPAREN   ,             // 0E: Right ...   ...         RPAREN
 TKT_LBRACKET ,             // 0F: Left bracket ...        LBRACKET
 TKT_RBRACKET ,             // 10: Right ...   ...         RBRACKET
 TKT_EOS      ,             // 11: End-of-Stmt (data is length of stmt including this token)
 TKT_EOL      ,             // 12: End-of-Line  ...
 TKT_SOS      ,             // 13: Start-of-Stmt (data is NULL)
 TKT_LINECONT ,             // 14: Line continuation (data is NULL)
 TKT_INPOUT   ,             // 15: Input/Output (data is UTF16_QUAD or UTF16_QUOTEQUAD symbol)

 TKT_LENGTHp1 ,             // 16: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 16: Strand accumulating (data is LPTOKEN)
 TKT_LISTINT  ,             // 17: List intermediate (data is HGLOBAL)
 TKT_LISTPAR  ,             // 18: List in parens    (data is HGLOBAL)
 TKT_LISTBR   ,             // 19: List in brackets  (data is HGLOBAL)
 TKT_VARARRAY ,             // 1A: Array of data (data is HGLOBAL)
 TKT_FCNARRAY ,             // 1B: Array of functions and/or operators (data is HGLOBAL)
 TKT_FCNNAMED ,             // 1C: A named function (data is LPSYMENTRY)
 TKT_AXISIMMED,             // 1D: An immediate axis specification (data is immediate)
 TKT_AXISARRAY,             // 1E: An array of  ...   (data is HGLOBAL)
 TKT_OP1NAMED ,             // 1F: A named monadic primitive operator (data is LPSYMENTRY)
 TKT_OP2NAMED ,             // 20: ...     dyadic  ...
 TKT_OP3NAMED ,             // 21: ...     ambiguous ...
 TKT_STRNAMED ,             // 22: A named strand
                            // 23-3F:  Available entries (6 bits)
} TOKEN_TYPES;
