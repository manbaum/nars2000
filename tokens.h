...
{TKT_VARNAMED = TKT_FIRST,  //  1: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 TKT_ASSIGN   ,             //  5: Assignment symbol (data is UCS2_LEFTARROW)
 TKT_LISTSEP  ,             //  6: List separator    (data is ';')
 TKT_FCNIMMED ,             //  7: An immediate primitive function (data is UCS2_***)
 TKT_OP1IMMED ,             //  8: An immediate monadic primitive operator (data is UCS2_***)
 ...
 TKT_LENGTHp1 ,             // 18: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 18: Strand accumulating (data is LPTOKEN)
 TKT_LIST     ,             // 19: List in parens    (data is HGLOBAL)
 TKT_VARARRAY ,             // 20: Array of data (data is HGLOBAL)
 TKT_FCNARRAY ,             // 21: Array of functions or monadic operators (data is HGLOBAL)
 TKT_FCNNAMED ,             // 22: Symbol table entry for a named function (data is LPSYMENTRY)
 TKT_AXISIMMED,             // 23: An immediate axis specification (data is immediate)
...
//   corresponding change to <Untokenize> and <GetTokenTypeName>
//   in <exec.c>. and <LookaheadDyadicOp>, <LookaheadAdjacent>,
//   <LookaheadSurround>, <MakeStrand>, and <yylex> in <parse.y>,
