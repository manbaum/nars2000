...

{
    ...
    Assert (lptkFunc->tkData.tkChar EQ UCS2_SLOPE
         || lptkFunc->tkData.tkChar EQ UCS2_SLOPEBAR);
...

{
    ...
    } else
    {
        ...
        if (lptkFunc->tkData.tkChar EQ UCS2_SLOPE)
...
#undef  lpAPA
    ...
    if (aplRankRht NE 0
     && uDimLftSum NE lpMemRhtDim[aplAxis])
    {
