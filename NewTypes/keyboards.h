...
#define DEAD_CS     {0, 0, 0, 1, 0, 0, 1, 0}
#define DEAD_AS     {0, 0, 0, 1, 0, 1, 0, 0}

#define CS      DEAD_CS
#define AS      DEAD_AS
#define UA      GLB_DEAD_KEY_A
#define UC      GLB_DEAD_KEY_C
#define UD      GLB_DEAD_KEY_D
#define UG      GLB_DEAD_KEY_G
#define UT      GLB_DEAD_KEY_T
...
{{L't', UTF16_TILDE             , 0, 0, L'T', UTF16_DIERESISTILDE     ,UT, 0}, CS}, // 14:  't'
 ...
 {  0 },                                                                            // 1D:  LCTL & RCTL
//  U    A                        C  AC   S   SA                       SC  SCA
{{L'a', UTF16_ALPHA             , 0, 0, L'A', 0                       ,UA, 0}, CS}, // 1E:  'a'
 {L's', UTF16_UPSTILE           , 0, 0, L'S', UTF16_SECTION           , 0, 0},      // 1F:  's'
{{L'd', UTF16_DOWNSTILE         , 0, 0, L'D', 0                       ,UD, 0}, CS}, // 20:  'd'
 {L'f', UTF16_INFINITY          , 0, 0, L'F', 0                       , 0, 0},      // 21:  'f'
{{L'g', UTF16_DEL               , 0, 0, L'G', UTF16_DIERESISDEL       ,UG, 0}, CS}, // 22:  'g'
...
{{L'c', UTF16_UPSHOE            , 0, 0, L'C', 0                       ,UC, 0}, CS}, // 2E:  'c'
...
{{L't', 0, UTF16_TILDE             , 0, L'T',UT, UTF16_DIERESISTILDE     , 0}, AS}, // 14:  't'
 ...
 {  0 },                                                                            // 1D:  LCTL & RCTL
//  U   A  C                        AC    S  SA  SC                       SCA
{{L'a', 0, UTF16_ALPHA             , 0, L'A',UA, 0                       , 0}, AS}, // 1E:  'a'
 {L's', 0, UTF16_UPSTILE           , 0, L'S', 0, UTF16_SECTION           , 0},      // 1F:  's'
{{L'd', 0, UTF16_DOWNSTILE         , 0, L'D',UD, 0                       , 0}, AS}, // 20:  'd'
 {L'f', 0, UTF16_INFINITY          , 0, L'F', 0, 0                       , 0},      // 21:  'f'
{{L'g', 0, UTF16_DEL               , 0, L'G',UG, UTF16_DIERESISDEL       , 0}, AS}, // 22:  'g'
...
{{L'c', 0, UTF16_UPSHOE            , 0, L'C',UC, 0                       , 0}, AS}, // 2E:  'c'
...
{{  L't' , 0x223C,  0    ,  0    ,  L'T' , 0x2368, UT    ,  0     }, CS},         // 14:  't'
...
{{  CIRCM, 0x2190,  0    ,  0    , DIER  , 0x235E,  0    ,  0     }, DEAD_UN_SH}, // 1A:  '['
 ...
 {  0 },                                                                          // 1C:  CR
 {  0 },                                                                          // 1D:  LCTL & RCTL
{{  L'q' , 0x237A,  0    ,  0    ,  L'Q' ,  0    , UA    ,  0     }, CS},         // 1E:  'a'
 {  L's' , 0x2308,  0    ,  0    ,  L'S' , 0x00A7,  0    ,  0     },              // 1F:  's'
{{  L'd' , 0x230A,  0    ,  0    ,  L'D' ,  0    , UD    ,  0     }, CS},         // 20:  'd'
 {  L'f' , 0x221E,  0    ,  0    ,  L'F' ,  0    ,  0    ,  0     },              // 21:  'f'
{{  L'g' , 0x2207,  0    ,  0    ,  L'G' , 0x2362, UG    ,  0     }, CS},         // 22:  'g'
...
{{  L'c' , 0x2229,  0    ,  0    ,  L'C' ,  0    , UC    ,  0     }, CS},         // 2E:  'c'
