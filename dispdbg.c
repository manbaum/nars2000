...
{{"VARNAMED"    , TKT_VARNAMED      },  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 {"CS_ENDFORLCL", TKT_CS_ENDFORLCL  },  // 23: ...                 ENDFORLCL  ...
 {"CS_ENDIF"    , TKT_CS_ENDIF      },  // 24: ...                 ENDIF      ...
 {"CS_ENDREPEAT", TKT_CS_ENDREPEAT  },  // 25: ...                 ENDREPEAT  ...
 {"CS_ENDSELECT", TKT_CS_ENDSELECT  },  // 26: ...                 ENDSELECT  ...
 {"CS_ENDWHILE" , TKT_CS_ENDWHILE   },  // 27: ...                 ENDWHILE   ...
 {"CS_FOR"      , TKT_CS_FOR        },  // 28: ...                 FOR        ...
 {"CS_FOR2"     , TKT_CS_FOR2       },  // 29: ...                 FOR2       ...
 {"CS_FORLCL"   , TKT_CS_FORLCL     },  // 2A: ...                 FORLCL     ...
 {"CS_GOTO"     , TKT_CS_GOTO       },  // 2B: ...                 GOTO       ...
 {"CS_IF"       , TKT_CS_IF         },  // 2C: ...                 IF         ...
 {"CS_IF2"      , TKT_CS_IF2        },  // 2D: ...                 IF2        ...
 {"CS_IN"       , TKT_CS_IN         },  // 2E: ...                 IN         ...
 {"CS_LEAVE"    , TKT_CS_LEAVE      },  // 2F: ...                 LEAVE      ...
 {"CS_ORIF"     , TKT_CS_ORIF       },  // 30: ...                 ORIF       ...
 {"CS_REPEAT"   , TKT_CS_REPEAT     },  // 31: ...                 REPEAT     ...
 {"CS_REPEAT2"  , TKT_CS_REPEAT2    },  // 32: ...                 REPEAT2    ...
 {"CS_RETURN"   , TKT_CS_RETURN     },  // 33: ...                 RETURN     ...
 {"CS_SELECT"   , TKT_CS_SELECT     },  // 34: ...                 SELECT     ...
 {"CS_SELECT2"  , TKT_CS_SELECT2    },  // 35: ...                 SELECT2    ...
 {"CS_UNTIL"    , TKT_CS_UNTIL      },  // 36: ...                 UNTIL      ...
 {"CS_WHILE"    , TKT_CS_WHILE      },  // 37: ...                 WHILE      ...
 {"CS_WHILE2"   , TKT_CS_WHILE2     },  // 38: ...                 WHILE2     ...
 {"CS_SKIPCASE" , TKT_CS_SKIPCASE   },  // 39: ...                 Special token
 {"CS_SKIPEND"  , TKT_CS_SKIPEND    },  // 3A: ...                 Special token
