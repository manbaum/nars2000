...
{ // Name					 Valence	Var?
	{WS_UCS2_QUAD L"alx"   ,    9,      TRUE , NULL          , NULL        },    //  0:  Attention Latent Expression
	{WS_UCS2_QUAD L"ct"    ,    9,      TRUE , NULL          , NULL        },    //  1:  Comparison Tolerance
	{WS_UCS2_QUAD L"elx"   ,    9,      TRUE , NULL          , NULL        },    //  2:  Error Latent Expression
	{WS_UCS2_QUAD L"io"    ,    9,      TRUE , NULL          , NULL        },    //  3:  Index Origin
	{WS_UCS2_QUAD L"lx"    ,    9,      TRUE , NULL          , NULL        },    //  4:  Latent Expression
	{WS_UCS2_QUAD L"pp"    ,    9,      TRUE , NULL          , NULL        },    //  5:  Printing Precision
	{WS_UCS2_QUAD L"pr"    ,    9,      TRUE , NULL          , NULL        },    //  6:  Prompt Replacement
	{WS_UCS2_QUAD L"pw"    ,    9,      TRUE , NULL          , NULL        },    //  7:  Printing Width
	{WS_UCS2_QUAD L"rl"    ,    9,      TRUE , NULL          , &lpSymQuadRL},    //  8:  Random Link
	{WS_UCS2_QUAD L"sa"    ,    9,      TRUE , NULL          , NULL        },    //  9:  Stop Action
	{WS_UCS2_QUAD L"wsid"  ,    9,      TRUE , NULL          , NULL        },    // 10:  Workspace Identifier
