...
PRIMSPEC PrimSpecNotEqual = {
    ...
    NULL,   // &PrimFnMonNotEqualBA1FisBA1F,
    NULL,   // &PrimFnMonNotEqualBA2FisBA2F,
    NULL,   // &PrimFnMonNotEqualBA4FisBA4F,
    NULL,   // &PrimFnMonNotEqualBA8FisBA8F,
    NULL,   // &PrimFnMonNotEqualARBisBA1F,
    NULL,   // &PrimFnMonNotEqualARBisBA2F,
    NULL,   // &PrimFnMonNotEqualARBisBA4F,
    NULL,   // &PrimFnMonNotEqualARBisBA8F,
    ...
    &PrimFnDydNotEqualBisBA1FvBA1F,
    &PrimFnDydNotEqualBisBA2FvBA2F,
    &PrimFnDydNotEqualBisBA4FvBA4F,
    &PrimFnDydNotEqualBisBA8FvBA8F,
    ...
    NULL,   // &PrimFnDydNotEqualBA1FisBA1FvBA1F,
    NULL,   // &PrimFnDydNotEqualBA2FisBA2FvBA2F,
    NULL,   // &PrimFnDydNotEqualBA4FisBA4FvBA4F,
    NULL,   // &PrimFnDydNotEqualBA8FisBA8FvBA8F,
...
////////    break;
        ...
        case ARRAY_BA8F:
            ...
            for (uCnt = 0; uCnt < aplNELMRht; uCnt++)
                // Save in the result
                *((LPAPLARB) lpMemRes)++ = SqNrmBAxF (((LPAPLARB) lpMemRht)++, iHCDimRht);
            break;
...
//  $PrimFnDydNotEqualBisBA1FvBA1F
//
//  Primitive scalar function dyadic NotEqual:  B {is} BA1F fn BA1F
//***************************************************************************

void PrimFnDydNotEqualBisBA1FvBA1F
    (LPAPLBOOL  lpMemRes,           // Ptr to the result
     APLUINT    uRes,               // Index into the result
     LPALLTYPES lpatLft,            // Ptr to left arg ALLTYPES
     LPALLTYPES lpatRht,            // ...    right ...
...

{
    ...
    lpMemRes[uRes >> LOG2NBIB] |=
      CmpCT_B (lpatLft->aplArb, lpatRht->aplArb, GetQuadCT (), NE)
      << (MASKLOG2NBIB & (UINT) uRes);
} // End PrimFnDydNotEqualBisBA1FvBA1F


//***************************************************************************
//  $PrimFnDydNotEqualBisBA2FvBA2F
//
//  Primitive scalar function dyadic NotEqual:  B {is} BA2F fn BA2F
//***************************************************************************

void PrimFnDydNotEqualBisBA2FvBA2F
    (LPAPLBOOL  lpMemRes,               // Ptr to the result
     APLUINT    uRes,                   // Index into the result
     LPALLTYPES lpatLft,                // Ptr to left arg ALLTYPES
     LPALLTYPES lpatRht,                // ...    right ...
...

{
    EqualBisBAxFvBAxF (lpMemRes,        // Ptr to the result
                       ...
                       FALSE,           // TRUE iff the calling function is Equal (FALSE if NotEqual)
                       WFCN);           // Ptr to CheckException msg
} // End PrimFnDydNotEqualBisBA2FvBA2F


//***************************************************************************
//  $PrimFnDydNotEqualBisBA4FvBA4F
//
//  Primitive scalar function dyadic NotEqual:  B {is} BA4F fn BA4F
//***************************************************************************

void PrimFnDydNotEqualBisBA4FvBA4F
    (LPAPLBOOL  lpMemRes,               // Ptr to the result
     APLUINT    uRes,                   // Index into the result
     LPALLTYPES lpatLft,                // Ptr to left arg ALLTYPES
     LPALLTYPES lpatRht,                // ...    right ...
...

{
    EqualBisBAxFvBAxF (lpMemRes,        // Ptr to the result
                       ...
                       FALSE,           // TRUE iff the calling function is Equal (FALSE if NotEqual)
                       WFCN);           // Ptr to CheckException msg
} // End PrimFnDydNotEqualBisBA4FvBA4F


//***************************************************************************
//  $PrimFnDydNotEqualBisBA8FvBA8F
//
//  Primitive scalar function dyadic NotEqual:  B {is} BA8F fn BA8F
//***************************************************************************

void PrimFnDydNotEqualBisBA8FvBA8F
    (LPAPLBOOL  lpMemRes,               // Ptr to the result
     APLUINT    uRes,                   // Index into the result
     LPALLTYPES lpatLft,                // Ptr to left arg ALLTYPES
     LPALLTYPES lpatRht,                // ...    right ...
...

{
    EqualBisBAxFvBAxF (lpMemRes,        // Ptr to the result
                       ...
                       FALSE,           // TRUE iff the calling function is Equal (FALSE if NotEqual)
                       WFCN);           // Ptr to CheckException msg
} // End PrimFnDydNotEqualBisBA8FvBA8F
