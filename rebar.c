...
#define LANGCHARS_SEPARATOR     {0, {0}},
    ...
    static LANGCHARS langChars[] =
    {
        ...
        {UTF16_CIRCLE             , {0}, L"Circle",
                                         ...
                                         L"Circle Functions:  -7" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" atanh (R)\n"
                                         L"                   -6" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" acosh (R)\n"
                                         L"                   -5" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" asinh (R)\n"
                                         L"                   -4" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" R" WS_UTF16_TIMES L"sqrt (1-R*" WS_UTF16_OVERBAR L"2)\n"
                                         L"                   -3" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" atan  (R)\n"
                                         L"                   -2" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" acos  (R)\n"
                                         L"                   -1" WS_UTF16_CIRCLE L"R " WS_UTF16_LEFTRIGHTARROWS L" asin  (R)\n"
