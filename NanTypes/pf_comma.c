    ...
    *VarArrayBaseToDim (lpMemHdrRes) = 1;
    ...
    switch (aplTypeRht)
    {
        ...
        case ARRAY_BA2F:
            ...
            for (i = 0; i < 2; i++)
                // Copy to the result
                arb_init_set (&((LPAPLBA2F) lpMemRes)->parts[i], &((LPAPLBA2F) lpMemRht)->parts[i]);
            break;
        ...
        case ARRAY_BA4F:
            ...
            for (i = 0; i < 4; i++)
                // Copy to the result
                arb_init_set (&((LPAPLBA4F) lpMemRes)->parts[i], &((LPAPLBA4F) lpMemRht)->parts[i]);
            break;
        ...
        case ARRAY_BA8F:
            ...
            for (i = 0; i < 8; i++)
                // Copy to the result
                arb_init_set (&((LPAPLBA8F) lpMemRes)->parts[i], &((LPAPLBA8F) lpMemRht)->parts[i]);
            break;
...
#undef  lpHeader
    ...
    if (!bReorder)
    {
        ...
        switch (aplTypeRht)
        {
            ...
            case ARRAY_HETERO:
                // Make a copy of each RAT/VFP/ARB item
            ...
            case ARRAY_VFP:
                // Make a copy of each VFP item
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                    mpfr_init_copy (&((LPAPLVFP) lpMemRes)[uRes], &((LPAPLVFP) lpMemRht)[uRes]);
                break;

            case ARRAY_ARB:
                // Make a copy of each ARB item
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                    arb_init_set (&((LPAPLARB) lpMemRes)[uRes], &((LPAPLARB) lpMemRht)[uRes]);
                break;
            ...
            case ARRAY_BA2F:
                ...
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                for (i = 0; i < 2; i++)
                    arb_init_set (&((LPAPLBA2F) lpMemRes)[uRes].parts[i], &((LPAPLBA2F) lpMemRht)[uRes].parts[i]);
                break;
            ...
            case ARRAY_BA4F:
                ...
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                for (i = 0; i < 4; i++)
                    arb_init_set (&((LPAPLBA4F) lpMemRes)[uRes].parts[i], &((LPAPLBA4F) lpMemRht)[uRes].parts[i]);
                break;
            ...
            case ARRAY_BA8F:
                ...
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                for (i = 0; i < 8; i++)
                    arb_init_set (&((LPAPLBA8F) lpMemRes)[uRes].parts[i], &((LPAPLBA8F) lpMemRht)[uRes].parts[i]);
                break;
            ...
            case ARRAY_BA8F:
                for (uRes = 0; uRes < aplNELMRht; uRes++)
                {
                    ...
                    switch (aplTypeRht)
                    {
                        ...
                        case ARRAY_ARB:
                            // Copy element # uRht from the right arg to lpMemRes[uRes]
                            arb_init_set (&((LPAPLARB) lpMemRes)[uRes], &((LPAPLARB) lpMemRht)[uRht]);
                        ...
                        case ARRAY_BA2F:
                            ...
                            for (i = 0; i < 2; i++)
                                // Copy element # uRht from the right arg to lpMemRes[uRes]
                                arb_init_set (&((LPAPLBA2F) lpMemRes)[uRes].parts[i], &((LPAPLBA2F) lpMemRht)[uRht].parts[i]);
                        ...
                        case ARRAY_BA4F:
                            ...
                            for (i = 0; i < 4; i++)
                                // Copy element # uRht from the right arg to lpMemRes[uRes]
                                arb_init_set (&((LPAPLBA4F) lpMemRes)[uRes].parts[i], &((LPAPLBA4F) lpMemRht)[uRht].parts[i]);
                        ...
                        case ARRAY_BA8F:
                            ...
                            for (i = 0; i < 8; i++)
                                // Copy element # uRht from the right arg to lpMemRes[uRes]
                                arb_init_set (&((LPAPLBA8F) lpMemRes)[uRes].parts[i], &((LPAPLBA8F) lpMemRht)[uRht].parts[i]);
        ...
        case ARRAY_NESTED:              // Res = NESTED, Lft/Rht = NESTED/HETERO/Num/CHAR
            ...
            for (uBeg = 0; uBeg < aplDimBeg; uBeg++)
            {
                ...
                switch (aplTypeLft)
                {
                    ...
                    case ARRAY_ARB:     // Res = NESTED, Lft = ARB
                    case ARRAY_BA2F:    // Res = NESTED, Lft = BA2F
                    case ARRAY_BA4F:    // Res = NESTED, Lft = BA4F
                    case ARRAY_BA8F:    // Res = NESTED, Lft = BA8F
                ...
                switch (aplTypeRht)
                {
                    ...
                    case ARRAY_ARB:     // Res = NESTED, Rht = ARB
                    ...
                    case ARRAY_BA2F:    // Res = NESTED, Rht = BA2F
                    case ARRAY_BA4F:    // Res = NESTED, Rht = BA4F
                    case ARRAY_BA8F:    // Res = NESTED, Rht = BA8F
