...
{   // FSROW_INIT       Initial state
 {{FSROW_INIT    , fnRepAcc  },         // 00:  Digit
  ...
  {FSROW_CHKEOS  , fnSetQual },         // 12:  ...            V
  {FSROW_CHKEOS  , fnSetQual },         // 13:  ...            X
  {FSROW_SPEC    , fnSetQual },         // 14:  ...            Z
  {FSROW_CHKEOS  , fnSetQual },         // 15:  Text leading delimiter
  {FSROW_ERROR   , fnError   },         // 16:  Comma
  {FSROW_INIT    , fnDnLvl   },         // 17:  Left paren
  {FSROW_ERROR   , fnError   },         // 18:  Right ...
  {FSROW_INIT    , NULL      },         // 19:  White space
  {FSROW_ERROR   , fnError   },         // 1A:  All other chars
  {FSROW_EXIT    , fnFmtExit },         // 1B:  End-Of-Line
 },
 ...
 {{FSROW_ERROR   , fnError   },         // 00:  Digit
  ...
  {FSROW_CHKEOS  , fnSetQual },         // 13:  ...            X
  {FSROW_SPEC    , fnSetQual },         // 14:  ...            Z
  {FSROW_CHKEOS  , fnSetQual },         // 15:  Text leading delmiter
  {FSROW_ERROR   , fnError   },         // 16:  Comma
  {FSROW_ERROR   , fnError   },         // 17:  Left paren
  {FSROW_ERROR   , fnError   },         // 18:  Right ...
  {FSROW_SPEC    , NULL      },         // 19:  White space
  {FSROW_ERROR   , fnError   },         // 1A:  All other chars
  {FSROW_ERROR   , fnError   },         // 1B:  End-Of-Line
 },
 ...
 {{FSROW_ERROR   , fnError   },         // 00:  Digit
  ...
  {FSROW_ERROR   , fnError   },         // 12:  ...            V
  {FSROW_ERROR   , fnError   },         // 13:  ...            X
  {FSROW_ERROR   , fnError   },         // 14:  ...            Z
  {FSROW_ERROR   , fnError   },         // 15:  Text leading delimiter
  {FSROW_INIT    , fnFmtDone },         // 16:  Comma
  {FSROW_ERROR   , fnError   },         // 17:  Left paren
  {FSROW_CHKEOS  , fnUpLvl   },         // 18:  Right ...
  {FSROW_CHKEOS  , NULL      },         // 19:  White space
  {FSROW_ERROR   , fnError   },         // 1A:  All other chars
  {FSROW_EXIT    , fnFmtExit },         // 1B:  End-Of-Line
 },
}
...
////////////    goto FORMAT_EXIT;
        ...
        case L'V':
            // Save as the format specification
            lpfsCur->fmtSpecVal = FMTSPECVAL_V;

            // Skip over the V-fmtspec
            lpfsLocalVars->lpwszCur++;
            lpfsLocalVars->uChar++;
            ...
            // Modifiers allowed for V-format:  all
            // ...       not ...             :  none
