        ...
        case ARRAY_BA8F:
            ...
            for (uHi = 0; uHi < uDimHi; uHi++)
            {
                ...
                for (uAx = 0; uAx < uDimAx; uAx++)
                {
                    ...
                    // Loop through all of the parts
                    for (i = 0; i < iHCDimRht; i++)
                        arb_init_set (&((LPAPLARB) lpMemRes)[i + iHCDimRht * (uDim +                 uAx  * uDimHi)],
                                      &((LPAPLARB) lpMemRht)[i + iHCDimRht * (uDim + ((uDimAx - 1) - uAx) * uDimHi)]);
                } // End FOR
            } // End FOR/FOR
        ...
        case ARRAY_BA8F:
            ...
            for (uHi = 0; uHi < uDimHi; uHi++)
            {
                ...
                for (uAx = 0; uAx < uDimAx; uAx++)
                {
                    ...
                    for (i = 0; i < iHCDimRht; i++)
                        arb_init_set (&((LPAPLARB) lpMemRes)[i + iHCDimRht * (uDim +                  uAx           * uDimHi)],
                                      &((LPAPLARB) lpMemRht)[i + iHCDimRht * (uDim + AplModI (uDimAx, uAx + aplRot) * uDimHi)]);
                } // End FOR
            } // End FOR/FOR
