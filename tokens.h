...
{TKT_VARNAMED = TKT_FIRST,  // 01: Symbol table entry for a named var      (data is LPSYMENTRY)
 ...
 TKT_LENGTHp1      ,        // 3F: Last token type
 ...
 TKT_STRAND = TKT_LENGTHp1, // 3F: Strand accumulating                     (data is LPTOKEN)
 ...
 TKT_FILLJOT       ,        // 4F: Fill jot
                            // 50-7F:  Available entries (7 bits)
} TOKEN_TYPES;
