...
{FSCOL_DIGIT = 0   ,                // 00:  Digit
 ...
 FSCOL_V           ,                // 13:  ...            V
 FSCOL_Z           ,                // 14:  ...            Z
 FSCOL_TXTDELIM    ,                // 15:  Text leading delimiter
                                    //      (SingleQuote, DoubleQuote, Quad, Quote-Quad, Dieresis, LeftCaret, LeftShoe)
 FSCOL_COMMA       ,                // 16:  Comma
 FSCOL_LEFTPAREN   ,                // 17:  Left paren
 FSCOL_RIGHTPAREN  ,                // 18:  Right ...
 FSCOL_SPACE       ,                // 19:  White space
 FSCOL_ALPHA       ,                // 1A:  All other chars
 FSCOL_EOL         ,                // 1B:  End-Of-Line

 FSCOL_LENGTH      ,                // 1C:  # column indices (cols in fsaActTableFS)
...
// The available letters are DHJUWY.
...
typedef enum tagFMT_SPEC_VAL
{
    ...
    FMTSPECVAL_V,                   // 07:  V-...
    FMTSPECVAL_X,                   // 08:  X-...
    FMTSPECVAL_TXT,                 // 09:  Text-...
    FMTSPECVAL_ERR,                 // 0A:  Error
...
#define STDSYMSUB           L"*.,0" DEF_UNDERFLOW_WS L"Z9" DEF_EXPONENT_UC_WS DEF_RATSEP_WS DEF_ARBSEP_WS
...
typedef enum tagSYM_SUB             // Symbol Substitution enum
{
    ...
    SYMSUB_ARB_SEP,                 // 09:  ± (Ball Arithmetic separator)
    SYMSUB_LENGTH,                  // 0A:  # entries in this enum
} SYMSUB, *LPSYMSUB;
