...
{{"VARNAMED"    , TKT_VARNAMED      },  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 {"STRAND"      , TKT_STRAND        },  // 3A: Strand accumulating (data is LPTOKEN)
 {"LISTINT"     , TKT_LISTINT       },  // 3B: List in parens    (data is HGLOBAL)
 {"LISTPAR"     , TKT_LISTPAR       },  // 3C: List in parens    (data is HGLOBAL)
 {"LSTIMMED"    , TKT_LSTIMMED      },  // 3D: List in brackets, single element, immed (data is immediate)
 {"LSTARRAY"    , TKT_LSTARRAY      },  // 3E: List in brackets, single element, array (data is HGLOBAL)
 {"LSTMULT"     , TKT_LSTMULT       },  // 3F: List in brackets, multiple elements (data is HGLOBAL)
 {"FCNARRAY"    , TKT_FCNARRAY      },  // 40: Array of functions (data is HGLOBAL)
 {"FCNNAMED"    , TKT_FCNNAMED      },  // 41: Symbol table entry for a named function (data is LPSYMENTRY)
 {"AXISIMMED"   , TKT_AXISIMMED     },  // 42: An immediate axis specification (data is immediate)
 {"AXISARRAY"   , TKT_AXISARRAY     },  // 43: An array of  ...   (data is HGLOBAL)
 {"OP1NAMED"    , TKT_OP1NAMED      },  // 44: A named monadic primitive operator (data is LPSYMENTRY)
 {"OP2NAMED"    , TKT_OP2NAMED      },  // 45: ...     dyadic  ...
 {"OP3NAMED"    , TKT_OP3NAMED      },  // 46: ...     ambiguous ...
 {"STRNAMED"    , TKT_STRNAMED      },  // 47: ...     strand  ...
 {"CS_NEC"      , TKT_CS_NEC        },  // 48: Control Structure:  Special token
 {"CS_EOL"      , TKT_CS_EOL        },  // 49: ...                 Special token
};
