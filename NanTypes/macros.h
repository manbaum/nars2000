...
#define IsMFOLclName(a)         ((a)[0] EQ WC_MFOLCL)
...
#define gAllowNeg0NE0       GetMemPTD()->aplCurrentFEATURE[FEATURENDX_NEG0_NE0   ]
...
#define gbAllowNeg0NE0       lpMemPTD  ->aplCurrentFEATURE[FEATURENDX_NEG0_NE0   ]  // ...
...
#define IsRank2P(ArrRank)               ((ArrRank) >= 2)

// Define macro for detecting rank 3 or higher rank arrays
#define IsRank3P(ArrRank)               ((ArrRank) >= 3)
...
#define IsQuadA(a)                  (strchrW (L"aAâÂäÄáÁàÀãÃ", (a)) NE NULL)
