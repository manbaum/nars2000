...
{{"VARNAMED"    , TKT_VARNAMED      },  // 01: Symbol table entry for a named var (data is LPSYMENTRY)
 ...
 {"COMMENT"     , TKT_COMMENT       },  // 05: Comment (data is NULL)
 ...
 {"CS_ELSE"     , TKT_CS_ELSE       },  // 1F: ...                 ELSE       ...
 {"CS_ELSEIF"   , TKT_CS_ELSEIF     },  // 20: ...                 ELSEIF     ...
 {"CS_END"      , TKT_CS_END        },  // 21: ...                 END        ...
 {"CS_ENDFOR"   , TKT_CS_ENDFOR     },  // 22: ...                 ENDFOR     ...
 ...
 {"CS_GOTO"     , TKT_CS_GOTO       },  // 29: ...                 GOTO       ...
 {"CS_IF"       , TKT_CS_IF         },  // 2A: ...                 IF         ...
 {"CS_IF2"      , TKT_CS_IF2        },  // 2B: ...                 IF2        ...
 {"CS_IN"       , TKT_CS_IN         },  // 2C: ...                 IN         ...
 {"CS_LEAVE"    , TKT_CS_LEAVE      },  // 2D: ...                 LEAVE      ...
 {"CS_ORIF"     , TKT_CS_ORIF       },  // 2E: ...                 ORIF       ...
 {"CS_REPEAT"   , TKT_CS_REPEAT     },  // 2F: ...                 REPEAT     ...
 {"CS_REPEAT2"  , TKT_CS_REPEAT2    },  // 30: ...                 REPEAT2    ...
 {"CS_RETURN"   , TKT_CS_RETURN     },  // 31: ...                 RETURN     ...
 {"CS_SELECT"   , TKT_CS_SELECT     },  // 32: ...                 SELECT     ...
 {"CS_SELECT2"  , TKT_CS_SELECT2    },  // 33: ...                 SELECT2    ...
 {"CS_UNTIL"    , TKT_CS_UNTIL      },  // 34: ...                 UNTIL      ...
 {"CS_WHILE"    , TKT_CS_WHILE      },  // 35: ...                 WHILE      ...
 {"CS_WHILE2"   , TKT_CS_WHILE2     },  // 36: ...                 WHILE2     ...
 {"CS_SKIPCASE" , TKT_CS_SKIPCASE   },  // 37: ...                 Special token
 {"CS_SKIPEND"  , TKT_CS_SKIPEND    },  // 38: ...                 Special token
 {"STRAND"      , TKT_STRAND        },  // 39: Strand accumulating (data is LPTOKEN)
 {"LISTINT"     , TKT_LISTINT       },  // 3A: List in parens    (data is HGLOBAL)
 {"LISTPAR"     , TKT_LISTPAR       },  // 3B: List in parens    (data is HGLOBAL)
 {"LSTIMMED"    , TKT_LSTIMMED      },  // 3C: List in brackets, single element, immed (data is immediate)
 {"LSTARRAY"    , TKT_LSTARRAY      },  // 3D: List in brackets, single element, array (data is HGLOBAL)
 {"LSTMULT"     , TKT_LSTMULT       },  // 3E: List in brackets, multiple elements (data is HGLOBAL)
 {"FCNARRAY"    , TKT_FCNARRAY      },  // 3F: Array of functions (data is HGLOBAL)
 {"FCNNAMED"    , TKT_FCNNAMED      },  // 40: Symbol table entry for a named function (data is LPSYMENTRY)
 {"AXISIMMED"   , TKT_AXISIMMED     },  // 41: An immediate axis specification (data is immediate)
 {"AXISARRAY"   , TKT_AXISARRAY     },  // 42: An array of  ...   (data is HGLOBAL)
 {"OP1NAMED"    , TKT_OP1NAMED      },  // 43: A named monadic primitive operator (data is LPSYMENTRY)
 {"OP2NAMED"    , TKT_OP2NAMED      },  // 44: ...     dyadic  ...
 {"OP3NAMED"    , TKT_OP3NAMED      },  // 45: ...     ambiguous ...
 {"STRNAMED"    , TKT_STRNAMED      },  // 46: ...     strand  ...
 {"CS_NEC"      , TKT_CS_NEC        },  // 47: Control Structure:  Special token
 {"CS_EOL"      , TKT_CS_EOL        },  // 48: ...                 Special token
};
