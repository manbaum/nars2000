...
//  $MyChooseFontCC
//
//  Choose a font for the Crash Control window.
//***************************************************************************
...
{
    // Initialize window-specific CHOOSEFONT data
    cfCC.hwndOwner = hWndMF;

    if (ChooseFont (&cfCC))      // Choose it
...
//  $MyChooseFontFE
//
//  Choose a font for the Function Editor windows.
//***************************************************************************
...
//  $MyChooseFontME
//
//  Choose a font for the Matrix Editor windows.
//***************************************************************************
...
{
    // Initialize window-specific CHOOSEFONT data
    cfPR.hwndOwner = hWndMF;

    if (ChooseFont (&cfPR))      // Choose it
        // Create a new font for the corresponding window
        CreateNewFontPR ();
} // End MyChooseFontPR
...
//  $MyChooseFontSM
//
//  Choose a font for the Session Manager windows.
//***************************************************************************
...
//  $MyChooseFontTC
//
//  Choose a font for the Tab Control window.
//***************************************************************************
...
//  $MyChooseFontVE
//
//  Choose a font for the Vector Editor windows.
//***************************************************************************
