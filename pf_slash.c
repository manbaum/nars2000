...

{
    ...
    Assert (lptkFunc->tkData.tkChar EQ UCS2_SLASH
         || lptkFunc->tkData.tkChar EQ UCS2_SLASHBAR);
...

{
    ...
    } else
    {
        ...
        if (lptkFunc->tkData.tkChar EQ UCS2_SLASH)
     ...
     && aplRankRht NE 0)
    {
        ...
        if (aplNELMLft NE lpMemRhtDim[aplAxis])
        {
    ...
    if (aplNELMLft EQ 1)
    {
        ...
        if (lpMemRhtDim)
            uDimAxRes  = aplIntegerLft * lpMemRhtDim[aplAxis];
        else
