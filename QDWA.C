...
//****************************************************************************
//  QDWA.C -- Windows API Cracker
//
//  This module is compiled for both 16- and 32-bit versions.
//****************************************************************************
#ifdef DEBUG
...
// In its infinite wisdom, in #define STRICT mode, the designers of W have
// declared its Handles (HSTR, HINSTANCE, HTASK, HRSRC, HDC, HGDIOBJ,
// HBITMAP, HPEN, HBRUSH, HRGRN, HPALLETTE, HFONT, HMETAFILE, HWND, HMENU,
// HICON, HDWP, HACCEL, and HDRVR) to be NEAR ptrs.  Hence when they are
// passed to a non-prototyped function such as wsprintf, what should be a
// 16-bit value in Win 3.x mode, is passed as a 32-bit value.  This leaves
// with no choice but to override the default type with HANDLE_WIDTH.
#ifdef _WIN32
#define HANDLE_WIDTH   DWORD
#else
#define HANDLE_WIDTH   WORD
#endif

#ifdef _WIN32
#define FmtStr      ", wParam = %08lX, lParam = %08lX\r\n"
#else
#define FmtStr      ", wParam = %04X, lParam = %08lX\r\n"
#endif
...
FLAGS Flags_BN[] =
{
    {"BN_CLICKED"               , BN_CLICKED  +0x80 , 0xFFFFFFFF},
    {"BN_PAINT"                 , BN_PAINT    +0x80 , 0xFFFFFFFF},
////{"BN_HILITE"                , BN_HILITE   +0x80 , 0xFFFFFFFF},    // BN_PUSHED
////{"BN_UNHILITE"              , BN_UNHILITE +0x80 , 0xFFFFFFFF},    // BN_UNPUSHED
    {"BN_DISABLE"               , BN_DISABLE  +0x80 , 0xFFFFFFFF},
#ifdef _WIN32
////{"BN_DOUBLECLICKED"         , BN_DOUBLECLICKED  , 0xFFFFFFFF},    // BN_DOUBLECLICK
    {"BN_PUSHED"                , BN_PUSHED   +0x80 , 0xFFFFFFFF},
    {"BN_UNPUSHED"              , BN_UNPUSHED +0x80 , 0xFFFFFFFF},
    {"BN_DBLCLK"                , BN_DBLCLK   +0x80 , 0xFFFFFFFF},
    {"BN_SETFOCUS"              , BN_SETFOCUS +0x80 , 0xFFFFFFFF},
    {"BN_KILLFOCUS"             , BN_KILLFOCUS+0x80 , 0xFFFFFFFF},
#endif
};
...
#ifdef _WIN32
FLAGS Flags_I_CHILDRENCALLBACK[] =
{
    {"I_CHILDRENCALLBACK"     , (UINT) I_CHILDRENCALLBACK  , 0xFFFFFFFF},
};
#define nFlags_I_CHILDRENCALLBACK (sizeof (Flags_I_CHILDRENCALLBACK)/sizeof (Flags_I_CHILDRENCALLBACK[0]))
#endif


#ifdef _WIN32
FLAGS Flags_I_IMAGECALLBACK[] =
{
    {"I_IMAGECALLBACK"        , (UINT) I_IMAGECALLBACK     , 0xFFFFFFFF},
};
#define nFlags_I_IMAGECALLBACK (sizeof (Flags_I_IMAGECALLBACK)/sizeof (Flags_I_IMAGECALLBACK[0]))
#endif
...
FLAGS Flags_ODT[] =
{
    {"ODT_BUTTON"             , ODT_BUTTON          , 0xFFFFFFFF},
    {"ODT_COMBOBOX"           , ODT_COMBOBOX        , 0xFFFFFFFF},
    {"ODT_LISTBOX"            , ODT_LISTBOX         , 0xFFFFFFFF},
    {"ODT_MENU"               , ODT_MENU            , 0xFFFFFFFF},
#ifdef _WIN32
    {"ODT_STATIC"             , ODT_STATIC          , 0xFFFFFFFF},
#endif
};
...
FLAGS Flags_SBN[] =
{
    {"SB_LINEUP/LEFT"       , SB_LINEUP        +0x80 , 0xFFFFFFFF},
////{"SB_LINEUP"            , SB_LINEUP        +0x80 , 0xFFFFFFFF},
////{"SB_LINELEFT"          , SB_LINELEFT      +0x80 , 0xFFFFFFFF},
    {"SB_LINEDOWN/RIGHT"    , SB_LINEDOWN      +0x80 , 0xFFFFFFFF},
////{"SB_LINEDOWN"          , SB_LINEDOWN      +0x80 , 0xFFFFFFFF},
////{"SB_LINERIGHT"         , SB_LINERIGHT     +0x80 , 0xFFFFFFFF},
    {"SB_PAGEUP/LEFT"       , SB_PAGEUP        +0x80 , 0xFFFFFFFF},
////{"SB_PAGEUP"            , SB_PAGEUP        +0x80 , 0xFFFFFFFF},
////{"SB_PAGELEFT"          , SB_PAGELEFT      +0x80 , 0xFFFFFFFF},
    {"SB_PAGEDOWN/RIGHT"    , SB_PAGEDOWN      +0x80 , 0xFFFFFFFF},
////{"SB_PAGEDOWN"          , SB_PAGEDOWN      +0x80 , 0xFFFFFFFF},
////{"SB_PAGERIGHT"         , SB_PAGERIGHT     +0x80 , 0xFFFFFFFF},
    {"SB_THUMBPOSITION"     , SB_THUMBPOSITION +0x80 , 0xFFFFFFFF},
    {"SB_THUMBTRACK"        , SB_THUMBTRACK    +0x80 , 0xFFFFFFFF},
    {"SB_TOP/LEFT"          , SB_TOP           +0x80 , 0xFFFFFFFF},
////{"SB_TOP"               , SB_TOP           +0x80 , 0xFFFFFFFF},
////{"SB_LEFT"              , SB_LEFT          +0x80 , 0xFFFFFFFF},
    {"SB_BOTTOM/RIGHT"      , SB_BOTTOM        +0x80 , 0xFFFFFFFF},
////{"SB_BOTTOM"            , SB_BOTTOM        +0x80 , 0xFFFFFFFF},
////{"SB_RIGHT"             , SB_RIGHT         +0x80 , 0xFFFFFFFF},
    {"SB_ENDSCROLL"         , SB_ENDSCROLL     +0x80 , 0xFFFFFFFF},
};
...
FLAGS Flags_STN[] =
{
    {"STN_CLICKED"     , STN_CLICKED+0x80 , 0xFFFFFFFF},
    {"STN_DBLCLK"      , STN_DBLCLK +0x80 , 0xFFFFFFFF},
    {"STN_ENABLE"      , STN_ENABLE +0x80 , 0xFFFFFFFF},
    {"STN_DISABLE"     , STN_DISABLE+0x80 , 0xFFFFFFFF},
};
...
FLAGS Flags_TVI[] =
{
    {"TVI_ROOT"               ,   (DWORD) TVI_ROOT  , 0xFFFFFFFF},
    {"TVI_FIRST"              ,   (DWORD) TVI_FIRST , 0xFFFFFFFF},
    {"TVI_LASDT"              ,   (DWORD) TVI_LAST  , 0xFFFFFFFF},
    {"TVI_SORT"               ,   (DWORD) TVI_SORT  , 0xFFFFFFFF},
};
#define nFlags_TVI      (sizeof (Flags_TVI)/sizeof (Flags_TVI[0]))
#endif
...
FLAGS Flags_TVIF[] =
{
    {"TVIF_CHILDREN"          ,   TVIF_CHILDREN      },
    {"TVIF_DI_SETITEM"        ,   TVIF_DI_SETITEM    },
    {"TVIF_HANDLE"            ,   TVIF_HANDLE        },
    {"TVIF_IMAGE"             ,   TVIF_IMAGE         },
    {"TVIF_INTEGRAL"          ,   TVIF_INTEGRAL      },
    {"TVIF_PARAM"             ,   TVIF_PARAM         },
    {"TVIF_SELECTEDIMAGE"     ,   TVIF_SELECTEDIMAGE },
    {"TVIF_STATE"             ,   TVIF_STATE         },
    {"TVIF_TEXT"              ,   TVIF_TEXT          },
};
#define nFlags_TVIF     (sizeof (Flags_TVIF)/sizeof (Flags_TVIF[0]))
#endif
...
#define nFlags_TVIS     (sizeof (Flags_TVIS)/sizeof (Flags_TVIS[0]))
#endif


#ifdef _WIN32
FLAGS Flags_TVISmask[] =
{
    {"TVIS_BOLD"            , TVIS_BOLD             },
    {"TVIS_CUT"             , TVIS_CUT              },
    {"TVIS_DROPHILITED"     , TVIS_DROPHILITED      },
    ...
    {"TVIS_EXPANDPARTIAL"   , TVIS_EXPANDPARTIAL    },
    {"TVIS_SELECTED"        , TVIS_SELECTED         },
    {"TVIS_OVERLAYMASK"     , TVIS_OVERLAYMASK      , TVIS_OVERLAYMASK   },
    {"TVIS_STATEIMAGEMASK"  , TVIS_STATEIMAGEMASK   , TVIS_STATEIMAGEMASK},
};
#define nFlags_TVISmask (sizeof (Flags_TVISmask)/sizeof (Flags_TVISmask[0]))
#endif
...
FLAGS Flags_WS[] =
{
    ...
    {"WS_BORDER"           , WS_BORDER      ,  WS_CAPTION},
    {"WS_DLGFRAME"         , WS_DLGFRAME    ,  WS_CAPTION},
...
#define nFlags_WS       (sizeof (Flags_WS)/sizeof (Flags_WS[0]))
...
////{"WS_EX_LEFT"               , WS_EX_LEFT           },   EQ 0
    {"WS_EX_RTLREADING"         , WS_EX_RTLREADING     },
////{"WS_EX_LTRREADING"         , WS_EX_LTRREADING     },   EQ 0
    {"WS_EX_LEFTSCROLLBAR"      , WS_EX_LEFTSCROLLBAR  },
////{"WS_EX_RIGHTSCROLLBAR"     , WS_EX_RIGHTSCROLLBAR },   EQ 0
...
#define nFlags_WS_EX    (sizeof (Flags_WS_EX)/sizeof (Flags_WS_EX[0]))
...
CLSTR clstr[] =
{
    ...
    {WC_BUTTONCHOICE   ,     "(BC)"  , EC_BUTTONCHOICE  },
#endif
...
LPSTR Format_RECT (const LPRECT lprc, LPSTR lpsz)
...
LPSTR FormatFlags (DWORD dwFlags, LPFLAGS lpFlags, int nFlags, LPSTR lpsz)
...

{
    ...
    t = l;                          // Start appending here

    for (p = lpsz; *p; )
    {
        // Find the end of the next item
        i = strcspn (p, ",|\r");    // Check for next item or flag separator
        q = p + i;                  // Point to the separator
        if (*q && (*q NE '\r'))     // If it's a separator (but not EOL), ...
            q++;                    // ...include it

        if (i EQ 0 || ((t - l) + (q - p)) > MAXLEN) // If it doesn't fit, ...
        {
            if (i EQ 0)             // If it's empty, ...
                p = q = q + 2;      // Skip over CR,LF
            if (*p)                 // If anything else on the next line
            {
                hmemcpy (t, "\r\n" INDENT, 2 + INDLEN); // Append EOL & INDENT
                l = t + 2;          // The line starts here
                t += 2 + INDLEN;    // Append here
                p = q = SkipWhite (p); // New start of input
            } // End IF
        } // End IF

        hmemcpy (t, p, q - p);      // Copy to destination
        t += q - p;                 // Skip over it

        p = q;                      // Start again here
    } // End FOR
...
void FAR __export __loadds ODS (LPSTR lpStr)
...
void FAR __export __loadds ODSDD (LPSTR lpStr, DWORD dw)
...
void FAR __export __loadds ODSRECT (LPSTR lpStr, LPRECT lprc)
...
//  ODSSIZE ()
//
//  Output Debug String with size cover function
//************************************************************************

void FAR __export __loadds ODSSIZE (LPSTR lpStr, LPSIZE lpsz)
...
LPSTR APIMsg (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam, LPSTR szTemp, BOOL bFlag)

{
#define WM(a)   case WM_##a:                    \
                    wsprintf (szTemp, "WM_" #a FmtStr, wParam, lParam); \
                    break;

#define EM(a)   case EM_##a:                    \
                    wsprintf (szTemp, "EM_" #a FmtStr, wParam, lParam); \
                    break;

#define BM(a)   case BM_##a:                    \
                    wsprintf (szTemp, "BM_" #a FmtStr, wParam, lParam); \
                    break;

#define CB(a)   case CB_##a:                    \
                    wsprintf (szTemp, "CB_" #a FmtStr, wParam, lParam); \
                    break;

#define LB(a)   case LB_##a:                    \
                    wsprintf (szTemp, "LB_" #a FmtStr, wParam, lParam); \
                    break;

#define SBM(a)  case SBM_##a:                    \
                    wsprintf (szTemp, "SBM_" #a FmtStr, wParam, lParam); \
                    break;

#define STM(a)  case STM_##a:                    \
                    wsprintf (szTemp, "STM_" #a FmtStr, wParam, lParam); \
                    break;
...
////// If flag says so, append wParam and lParam
////if (Debug && bFlag)
////    wsprintf (&szTemp[lstrlen (szTemp)], FmtStr, wParam, lParam);
////
    if (Debug)
    switch (message)
    {
        ...
        EM (REPLACESEL)                 // 00C2
                                        // 00C3
        EM (GETLINE)                    // 00C4
        EM (SETLIMITTEXT)               // 00C5 a.k.a. EM_LIMITTEXT
        EM (CANUNDO)                    // 00C6
        EM (UNDO)                       // 00C7
        EM (FMTLINES)                   // 00C8
        EM (LINEFROMCHAR)               // 00C9
                                        // 00CA
        EM (SETTABSTOPS)                // 00CB
        EM (SETPASSWORDCHAR)            // 00CC
        EM (EMPTYUNDOBUFFER)            // 00CD
        EM (GETFIRSTVISIBLELINE)        // 00CE
        EM (SETREADONLY)                // 00CF
        EM (SETWORDBREAKPROC)           // 00D0
        EM (GETWORDBREAKPROC)           // 00D1
        EM (GETPASSWORDCHAR)            // 00D2
        EM (SETMARGINS)                 // 00D3
        EM (GETMARGINS)                 // 00D4
        EM (GETLIMITTEXT)               // 00D5
        EM (POSFROMCHAR)                // 00D6
        EM (CHARFROMPOS)                // 00D7
        EM (SETIMESTATUS)               // 00D8
        EM (GETIMESTATUS)               // 00D9
                                        // 00DA-00DF
        SBM (SETPOS)                    // 00E0
        SBM (GETPOS)                    // 00E1
        SBM (SETRANGE)                  // 00E2
        SBM (GETRANGE)                  // 00E3
        SBM (ENABLE_ARROWS)             // 00E4
                                        // 00E5
        SBM (SETRANGEREDRAW)            // 00E6
                                        // 00E7-00E8
        SBM (SETSCROLLINFO)             // 00E9
        SBM (GETSCROLLINFO)             // 00EA
                                        // 00EB-00EF
        BM (GETCHECK)                   // 00F0
        BM (SETCHECK)                   // 00F1
        BM (GETSTATE)                   // 00F2
...
/////// WM (IME_KEYLAST)                // 010F
        ...
        CB (SETEDITSEL)                 // 0142
        CB (ADDSTRING)                  // 0143
        CB (DELETESTRING)               // 0144
        CB (DIR)                        // 0145
        CB (GETCOUNT)                   // 0146
        CB (GETCURSEL)                  // 0147
        CB (GETLBTEXT)                  // 0148
        CB (GETLBTEXTLEN)               // 0149
        CB (INSERTSTRING)               // 014A
        CB (RESETCONTENT)               // 014B
        CB (FINDSTRING)                 // 014C
        CB (SELECTSTRING)               // 014D
        CB (SETCURSEL)                  // 014E
        CB (SHOWDROPDOWN)               // 014F
        CB (GETITEMDATA)                // 0150
        CB (SETITEMDATA)                // 0151
        CB (GETDROPPEDCONTROLRECT)      // 0152
        CB (SETITEMHEIGHT)              // 0153
        CB (GETITEMHEIGHT)              // 0154
        CB (SETEXTENDEDUI)              // 0155
        CB (GETEXTENDEDUI)              // 0156
        CB (GETDROPPEDSTATE)            // 0157
        CB (FINDSTRINGEXACT)            // 0158
        CB (SETLOCALE)                  // 0159
        CB (GETLOCALE)                  // 015A
        CB (GETTOPINDEX)                // 015B
        CB (SETTOPINDEX)                // 015C
        CB (GETHORIZONTALEXTENT)        // 015D
        CB (SETHORIZONTALEXTENT)        // 015E
        CB (GETDROPPEDWIDTH)            // 015F
        CB (SETDROPPEDWIDTH)            // 0160
        CB (INITSTORAGE)                // 0161
////////CB (MULTIPLEADDSTRING)          // 0163         _WIN32_WCE >= 0x0400
                                        // 0164-016F
        STM (SETICON)                   // 0170
        STM (GETICON)                   // 0171
        STM (SETIMAGE)                  // 0172
        STM (GETIMAGE)                  // 0173
                                        // 0174-017F
        LB (ADDSTRING)                  // 0180
        LB (INSERTSTRING)               // 0181
        LB (DELETESTRING)               // 0182
        LB (SELITEMRANGEEX)             // 0183
        LB (RESETCONTENT)               // 0184
        LB (SETSEL)                     // 0185
        LB (SETCURSEL)                  // 0186
        LB (GETSEL)                     // 0187
        LB (GETCURSEL)                  // 0188
        ...
        LB (GETSELITEMS)                // 0191
        LB (SETTABSTOPS)                // 0192
        LB (GETHORIZONTALEXTENT)        // 0193
        LB (SETHORIZONTALEXTENT)        // 0194
        LB (SETCOLUMNWIDTH)             // 0195
        LB (ADDFILE)                    // 0196
        LB (SETTOPINDEX)                // 0197
        LB (GETITEMRECT)                // 0198
        LB (GETITEMDATA)                // 0199
        LB (SETITEMDATA)                // 019A
        LB (SELITEMRANGE)               // 019B
        LB (SETANCHORINDEX)             // 019C
        LB (GETANCHORINDEX)             // 019D
        LB (SETCARETINDEX)              // 019E
        LB (GETCARETINDEX)              // 019F
        LB (SETITEMHEIGHT)              // 01A0
        LB (GETITEMHEIGHT)              // 01A1
        LB (FINDSTRINGEXACT)            // 01A2
        LB (SETLOCALE)                  // 01A5
        LB (GETLOCALE)                  // 01A6
        LB (SETCOUNT)                   // 01A7
        LB (INITSTORAGE)                // 01A8
        LB (ITEMFROMPOINT)              // 01A9
////////LB (MULTIPLEADDSTRING)          // 01B1         _WIN32_WCE >= 0x0400
                                        // 01B2-01FF
...
////                    Format_CCM (szTemp, hWnd, message, wParam, lParam); // CCM_FIRST=0x2000
////                    break;
////
////                case EC_DATETIMEPICK:
////                    // Handle Date Time Picker messages
////                    Format_DTM (szTemp, hWnd, message, wParam, lParam); // DTM_FIRST=0x1000
////                    break;
////
                    case EC_HEADER:
                        // Handle Header messages
                        Format_HDM (szTemp, hWnd, message, wParam, lParam); // HDM_FIRST=0x1200
                        break;
#endif
                    case EC_LISTBOX:
                        // Handle Listbox messages
                        Format_LBM (szTemp, hWnd, message, wParam, lParam); // LB_FIRST=WM_USER + 1
                        break;
#ifdef _WIN32
                    case EC_LISTVIEW:
                        // Handle ListView messages
                        Format_LVM (szTemp, hWnd, message, wParam, lParam); // LVM_FIRST=0x1000
                        break;

////                case EC_MONTHCAL:
////                    // Handle Month Calendar messages
////                    Format_MCM (szTemp, hWnd, message, wParam, lParam); // MCM_FIRST=0x1000
////                    break;
////
////                case EC_PAGESCROLLER:
////                    // Handle Page Scroller messages
////                    Format_PGM (szTemp, hWnd, message, wParam, lParam); // PGM_FIRST=0x1400
////                    break;
////
////                case EC_TAB:
////                    // Handle Tab Control messages
////                    Format_TCM (szTemp, hWnd, message, wParam, lParam); // TCM_FIRST=0x1300
////                    break;
////
#endif
                    case EC_TOOLTIPS:
                        // Handle ToolTips messages
                        Format_TTM (szTemp, hWnd, message, wParam, lParam); // TTM_FIRST=0x0401
                        break;
#ifdef _WIN32
                    case EC_TREEVIEW:
                        // Handle TreeView messages
                        Format_TVM (szTemp, hWnd, message, wParam, lParam); // TV_FIRST =0x1100
                        break;
#endif
                    default:
                        wsprintf (szTemp, "WM_USER+%u" FmtStr, message - WM_USER, wParam, lParam);
                        break;
                } // End SWITCH
            } else
            if (WM_APP  <= message)
                wsprintf (szTemp, "WM_APP+%u" FmtStr,  message - WM_APP, wParam, lParam);
            else
                wsprintf (szTemp, "%04X" FmtStr,  message, wParam, lParam);
            break;
    } // End SWITCH
...
void Format_HDM (char szTemp[], HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)

{
    void (*Append) (LPSTR, HWND, WPARAM, LPARAM) = NULL;

#define HDM(a)  case HDM_##a:                   \
                    wsprintf (szTemp, "HDM_" #a FmtStr, wParam, lParam);\
                    Append = Append_HDM_##a; \
                    break;

#define Append_HDM_GETITEMCOUNT           NULL
#define Append_HDM_INSERTITEMA            NULL
#define Append_HDM_INSERTITEMW            NULL
#define Append_HDM_DELETEITEM             NULL
#define Append_HDM_GETITEMA               NULL
#define Append_HDM_GETITEMW               NULL
#define Append_HDM_SETITEMA               NULL
#define Append_HDM_SETITEMW               NULL
#define Append_HDM_LAYOUT                 NULL
#define Append_HDM_HITTEST                NULL
#define Append_HDM_GETITEMRECT            NULL
#define Append_HDM_SETIMAGELIST           NULL
#define Append_HDM_GETIMAGELIST           NULL
#define Append_HDM_ORDERTOINDEX           NULL
#define Append_HDM_CREATEDRAGIMAGE        NULL
#define Append_HDM_GETORDERARRAY          NULL
#define Append_HDM_SETORDERARRAY          NULL
#define Append_HDM_SETHOTDIVIDER          NULL
#define Append_HDM_SETBITMAPMARGIN        NULL
#define Append_HDM_GETBITMAPMARGIN        NULL
#define Append_HDM_SETFILTERCHANGETIMEOUT NULL
#define Append_HDM_EDITFILTER             NULL
#define Append_HDM_CLEARFILTER            NULL
    ...
    if (Append)             // If there's a special display routine, ...
        (*Append) (&szTemp[lstrlen (szTemp)], hWnd, wParam, lParam); // Call it
} // Format_HDM ()
#endif
...
//  Format_LBM
//
//  Format Listbox message
//************************************************************************

void Format_LBM (char szTemp[], HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)

{
    void (*Append) (LPSTR, HWND, WPARAM, LPARAM) = NULL;

#define LBM(a)  case LB_##a:                   \
                    wsprintf (szTemp, "LB_" #a FmtStr, wParam, lParam);\
                    Append = Append_LBM_##a; \
                    break;

#define Append_LBM_ADDSTRING              NULL
#define Append_LBM_INSERTSTRING           NULL
#define Append_LBM_DELETESTRING           NULL
#define Append_LBM_SELITEMRANGEEX         NULL
#define Append_LBM_RESETCONTENT           NULL
#define Append_LBM_SETSEL                 NULL
#define Append_LBM_SETCURSEL              NULL
#define Append_LBM_GETSEL                 NULL
#define Append_LBM_GETCURSEL              NULL
#define Append_LBM_GETTEXT                NULL
#define Append_LBM_GETTEXTLEN             NULL
#define Append_LBM_GETCOUNT               NULL
#define Append_LBM_SELECTSTRING           NULL
#define Append_LBM_DIR                    NULL
#define Append_LBM_GETTOPINDEX            NULL
#define Append_LBM_FINDSTRING             NULL
#define Append_LBM_GETSELCOUNT            NULL
#define Append_LBM_GETSELITEMS            NULL
#define Append_LBM_SETTABSTOPS            NULL
#define Append_LBM_GETHORIZONTALEXTENT    NULL
#define Append_LBM_SETHORIZONTALEXTENT    NULL
#define Append_LBM_SETCOLUMNWIDTH         NULL
#define Append_LBM_ADDFILE                NULL
#define Append_LBM_SETTOPINDEX            NULL
#define Append_LBM_GETITEMRECT            NULL
#define Append_LBM_GETITEMDATA            NULL
#define Append_LBM_SETITEMDATA            NULL
#define Append_LBM_SELITEMRANGE           NULL
#define Append_LBM_SETANCHORINDEX         NULL
#define Append_LBM_GETANCHORINDEX         NULL
#define Append_LBM_SETCARETINDEX          NULL
#define Append_LBM_GETCARETINDEX          NULL
#define Append_LBM_SETITEMHEIGHT          NULL
#define Append_LBM_GETITEMHEIGHT          NULL
#define Append_LBM_FINDSTRINGEXACT        NULL
#define Append_LBM_SETLOCALE              NULL
#define Append_LBM_GETLOCALE              NULL
#define Append_LBM_SETCOUNT               NULL
#define Append_LBM_INITSTORAGE            NULL
#define Append_LBM_ITEMFROMPOINT          NULL
#define Append_LBM_MULTIPLEADDSTRING      NULL

    switch (message)
    {                                   //  Win16          Win32
        LBM (ADDSTRING)                 // WM_USER +   1   0x180
        LBM (INSERTSTRING)              // WM_USER +   2   0x181
        LBM (DELETESTRING)              // WM_USER +   3   0x182
#ifdef _WIN32
        LBM (SELITEMRANGEEX)            // WM_USER +   4   0x183
#endif
        LBM (RESETCONTENT)              // WM_USER +   5   0x184
        LBM (SETSEL)                    // WM_USER +   6   0x185
        LBM (SETCURSEL)                 // WM_USER +   7   0x186
        LBM (GETSEL)                    // WM_USER +   8   0x187
        LBM (GETCURSEL)                 // WM_USER +   9   0x188
        LBM (GETTEXT)                   // WM_USER +  10   0x189
        LBM (GETTEXTLEN)                // WM_USER +  11   0x18A
        LBM (GETCOUNT)                  // WM_USER +  12   0x18B
        LBM (SELECTSTRING)              // WM_USER +  13   0x18C
        LBM (DIR)                       // WM_USER +  14   0x18D
        LBM (GETTOPINDEX)               // WM_USER +  15   0x18E
        LBM (FINDSTRING)                // WM_USER +  16   0x18F
        LBM (GETSELCOUNT)               // WM_USER +  17   0x190
        LBM (GETSELITEMS)               // WM_USER +  18   0x191
        LBM (SETTABSTOPS)               // WM_USER +  19   0x192
        LBM (GETHORIZONTALEXTENT)       // WM_USER +  20   0x193
        LBM (SETHORIZONTALEXTENT)       // WM_USER +  21   0x194
        LBM (SETCOLUMNWIDTH)            // WM_USER +  22   0x195
#ifdef _WIN32
        LBM (ADDFILE)                   // WM_USER +  23   0x196
#endif
        LBM (SETTOPINDEX)               // WM_USER +  24   0x197
        LBM (GETITEMRECT)               // WM_USER +  25   0x198
        LBM (GETITEMDATA)               // WM_USER +  26   0x199
        LBM (SETITEMDATA)               // WM_USER +  27   0x19A
        LBM (SELITEMRANGE)              // WM_USER +  28   0x19B
#ifdef _WIN32
        LBM (SETANCHORINDEX)            // WM_USER +  29   0x19C
        LBM (GETANCHORINDEX)            // WM_USER +  30   0x19D
#endif
        LBM (SETCARETINDEX)             // WM_USER +  31   0x19E
        LBM (GETCARETINDEX)             // WM_USER +  32   0x19F
        LBM (SETITEMHEIGHT)             // WM_USER +  33   0x1A0
        LBM (GETITEMHEIGHT)             // WM_USER +  34   0x1A1
        LBM (FINDSTRINGEXACT)           // WM_USER +  35   0x1A2
#ifdef _WIN32
        LBM (SETLOCALE)                 // WM_USER +  36   0x1A5
        LBM (GETLOCALE)                 // WM_USER +  37   0x1A6
        LBM (SETCOUNT)                  // WM_USER +  38   0x1A7
        LBM (INITSTORAGE)               // WM_USER +  39   0x1A8
        LBM (ITEMFROMPOINT)             // WM_USER +  40   0x1A9
/////// LBM (MULTIPLEADDSTRING)         // WM_USER +  41   0x1B1 (_WIN32_WCE >= 0x0400)
#endif
...
void Format_LVM (char szTemp[], HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)

{
    void (*Append) (LPSTR, HWND, WPARAM, LPARAM) = NULL;

#define LVM(a)  case LVM_##a:                   \
                    wsprintf (szTemp, "LVM_" #a FmtStr, wParam, lParam);\
                    Append = Append_LVM_##a; \
                    break;

#define Append_LVM_GETBKCOLOR               NULL
#define Append_LVM_SETBKCOLOR               NULL
#define Append_LVM_GETIMAGELIST             NULL
#define Append_LVM_SETIMAGELIST             NULL
#define Append_LVM_GETITEMCOUNT             NULL
#define Append_LVM_GETITEMA                 NULL
#define Append_LVM_SETITEMA                 NULL
#define Append_LVM_INSERTITEMA              NULL
#define Append_LVM_DELETEITEM               NULL
#define Append_LVM_DELETEALLITEMS           NULL
#define Append_LVM_GETCALLBACKMASK          NULL
#define Append_LVM_SETCALLBACKMASK          NULL
#define Append_LVM_GETNEXTITEM              NULL
#define Append_LVM_FINDITEMA                NULL
#define Append_LVM_GETITEMRECT              NULL
#define Append_LVM_SETITEMPOSITION          NULL
#define Append_LVM_GETITEMPOSITION          NULL
#define Append_LVM_GETSTRINGWIDTHA          NULL
#define Append_LVM_HITTEST                  NULL
#define Append_LVM_ENSUREVISIBLE            NULL
#define Append_LVM_SCROLL                   NULL
#define Append_LVM_REDRAWITEMS              NULL
#define Append_LVM_ARRANGE                  NULL
#define Append_LVM_EDITLABELA               NULL
#define Append_LVM_GETEDITCONTROL           NULL
#define Append_LVM_GETCOLUMNA               NULL
#define Append_LVM_SETCOLUMNA               NULL
#define Append_LVM_INSERTCOLUMNA            NULL
#define Append_LVM_DELETECOLUMN             NULL
#define Append_LVM_GETCOLUMNWIDTH           NULL
#define Append_LVM_SETCOLUMNWIDTH           NULL
#define Append_LVM_GETHEADER                NULL
#define Append_LVM_CREATEDRAGIMAGE          NULL
#define Append_LVM_GETVIEWRECT              NULL
#define Append_LVM_GETTEXTCOLOR             NULL
#define Append_LVM_SETTEXTCOLOR             NULL
#define Append_LVM_GETTEXTBKCOLOR           NULL
#define Append_LVM_SETTEXTBKCOLOR           NULL
#define Append_LVM_GETTOPINDEX              NULL
#define Append_LVM_GETCOUNTPERPAGE          NULL
#define Append_LVM_GETORIGIN                NULL
#define Append_LVM_UPDATE                   NULL
#define Append_LVM_SETITEMSTATE             NULL
#define Append_LVM_GETITEMSTATE             NULL
#define Append_LVM_GETITEMTEXTA             NULL
#define Append_LVM_SETITEMTEXTA             NULL
#define Append_LVM_SETITEMCOUNT             NULL
#define Append_LVM_SORTITEMS                NULL
#define Append_LVM_SETITEMPOSITION32        NULL
#define Append_LVM_GETSELECTEDCOUNT         NULL
#define Append_LVM_GETITEMSPACING           NULL
#define Append_LVM_GETISEARCHSTRINGA        NULL
#define Append_LVM_SETICONSPACING           NULL
#define Append_LVM_SETEXTENDEDLISTVIEWSTYLE NULL
#define Append_LVM_GETEXTENDEDLISTVIEWSTYLE NULL
#define Append_LVM_GETSUBITEMRECT           NULL
#define Append_LVM_SUBITEMHITTEST           NULL
#define Append_LVM_SETCOLUMNORDERARRAY      NULL
#define Append_LVM_GETCOLUMNORDERARRAY      NULL
#define Append_LVM_SETHOTITEM               NULL
#define Append_LVM_GETHOTITEM               NULL
#define Append_LVM_SETHOTCURSOR             NULL
#define Append_LVM_GETHOTCURSOR             NULL
#define Append_LVM_APPROXIMATEVIEWRECT      NULL
#define Append_LVM_SETWORKAREAS             NULL
#define Append_LVM_GETSELECTIONMARK         NULL
#define Append_LVM_SETSELECTIONMARK         NULL
#define Append_LVM_SETBKIMAGEA              NULL
#define Append_LVM_GETBKIMAGEA              NULL
#define Append_LVM_GETWORKAREAS             NULL
#define Append_LVM_SETHOVERTIME             NULL
#define Append_LVM_GETHOVERTIME             NULL
#define Append_LVM_GETNUMBEROFWORKAREAS     NULL
#define Append_LVM_SETTOOLTIPS              NULL
#define Append_LVM_GETITEMW                 NULL
#define Append_LVM_SETITEMW                 NULL
#define Append_LVM_INSERTITEMW              NULL
#define Append_LVM_GETTOOLTIPS              NULL
#define Append_LVM_SORTITEMSEX              NULL
#define Append_LVM_FINDITEMW                NULL
#define Append_LVM_GETSTRINGWIDTHW          NULL
#define Append_LVM_GETCOLUMNW               NULL
#define Append_LVM_SETCOLUMNW               NULL
#define Append_LVM_INSERTCOLUMNW            NULL
#define Append_LVM_GETITEMTEXTW             NULL
#define Append_LVM_SETITEMTEXTW             NULL
#define Append_LVM_GETISEARCHSTRINGW        NULL
#define Append_LVM_EDITLABELW               NULL
#define Append_LVM_SETBKIMAGEW              NULL
#define Append_LVM_GETBKIMAGEW              NULL
...
void Format_TTM (char szTemp[], HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)

{
    void (*Append) (LPSTR, HWND, WPARAM, LPARAM) = NULL;

#define TTM(a)  case TTM_##a:                   \
                    wsprintf (szTemp, "TTM_" #a FmtStr, wParam, lParam);\
                    Append = Append_TTM_##a; \
                    break;

#define Append_TTM_ACTIVATE           NULL
#define Append_TTM_SETDELAYTIME       NULL
#define Append_TTM_ADDTOOLA           NULL
#define Append_TTM_DELTOOLA           NULL
#define Append_TTM_NEWTOOLRECTA       NULL
//efine Append_TTM_RELAYEVENT         NULL
#define Append_TTM_GETTOOLINFOA       NULL
#define Append_TTM_SETTOOLINFOA       NULL
#define Append_TTM_HITTESTA           NULL
#define Append_TTM_GETTEXTA           NULL
#define Append_TTM_UPDATETIPTEXTA     NULL
#define Append_TTM_GETTOOLCOUNT       NULL
#define Append_TTM_ENUMTOOLSA         NULL
#define Append_TTM_GETCURRENTTOOLA    NULL
#define Append_TTM_WINDOWFROMPOINT    NULL
#define Append_TTM_TRACKACTIVATE      NULL
#define Append_TTM_TRACKPOSITION      NULL
#define Append_TTM_SETTIPBKCOLOR      NULL
#define Append_TTM_SETTIPTEXTCOLOR    NULL
#define Append_TTM_GETDELAYTIME       NULL
#define Append_TTM_GETTIPBKCOLOR      NULL
#define Append_TTM_GETTIPTEXTCOLOR    NULL
#define Append_TTM_SETMAXTIPWIDTH     NULL
#define Append_TTM_GETMAXTIPWIDTH     NULL
#define Append_TTM_SETMARGIN          NULL
#define Append_TTM_GETMARGIN          NULL
#define Append_TTM_POP                NULL
#define Append_TTM_UPDATE             NULL
#define Append_TTM_GETBUBBLESIZE      NULL
#define Append_TTM_ADJUSTRECT         NULL
#define Append_TTM_SETTITLEA          NULL
#define Append_TTM_SETTITLEW          NULL
#define Append_TTM_ADDTOOLW           NULL
#define Append_TTM_DELTOOLW           NULL
#define Append_TTM_NEWTOOLRECTW       NULL
#define Append_TTM_GETTOOLINFOW       NULL
#define Append_TTM_SETTOOLINFOW       NULL
#define Append_TTM_HITTESTW           NULL
#define Append_TTM_GETTEXTW           NULL
#define Append_TTM_UPDATETIPTEXTW     NULL
#define Append_TTM_ENUMTOOLSW         NULL
#define Append_TTM_GETCURRENTTOOLW    NULL
...
//************************************************************************
//  Append_TTM_RELAYEVENT
//
//  Append message data
//************************************************************************

void Append_TTM_RELAYEVENT (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
#define lpmsg   ((LPMSG) lParam)
    ...
    wsprintf (lpsz,
              ...
              "time = %08lX, "
              "pt = %08lX",
              (HANDLE_WIDTH) lpmsg->hwnd,
              APIMsg (lpmsg->hwnd, lpmsg->message, lpmsg->wParam, lpmsg->lParam, szTemp, FALSE),
              lpmsg->wParam,
              lpmsg->lParam,
              lpmsg->time,
              lpmsg->pt);
#undef lpmsg
} // End Append_TTM_RELAYEVENT ()
...
void Format_TVM (char szTemp[], HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)

{
    void (*Append) (LPSTR, HWND, WPARAM, LPARAM) = NULL;

#define TVM(a)  case TVM_##a:                   \
                    wsprintf (szTemp, "TVM_" #a FmtStr, wParam, lParam);\
                    Append = Append_TVM_##a; \
                    break;

//efine Append_TVM_INSERTITEMA        NULL
#define Append_TVM_DELETEITEM         NULL
#define Append_TVM_EXPAND             NULL
#define Append_TVM_GETITEMRECT        NULL
#define Append_TVM_GETCOUNT           NULL
#define Append_TVM_GETINDENT          NULL
#define Append_TVM_SETINDENT          NULL
#define Append_TVM_GETIMAGELIST       NULL
#define Append_TVM_SETIMAGELIST       NULL
#define Append_TVM_GETNEXTITEM        NULL
#define Append_TVM_SELECTITEM         NULL
#define Append_TVM_GETITEMA           NULL
//efine Append_TVM_SETITEMA           NULL
#define Append_TVM_EDITLABELA         NULL
#define Append_TVM_GETEDITCONTROL     NULL
#define Append_TVM_GETVISIBLECOUNT    NULL
#define Append_TVM_HITTEST            NULL
#define Append_TVM_CREATEDRAGIMAGE    NULL
#define Append_TVM_SORTCHILDREN       NULL
#define Append_TVM_ENSUREVISIBLE      NULL
#define Append_TVM_SORTCHILDRENCB     NULL
#define Append_TVM_ENDEDITLABELNOW    NULL
#define Append_TVM_GETISEARCHSTRINGA  NULL
#define Append_TVM_SETTOOLTIPS        NULL
#define Append_TVM_GETTOOLTIPS        NULL
#define Append_TVM_SETINSERTMARK      NULL
#define Append_TVM_SETUNICODEFORMAT   NULL
#define Append_TVM_GETUNICODEFORMAT   NULL
#define Append_TVM_SETITEMHEIGHT      NULL
#define Append_TVM_GETITEMHEIGHT      NULL
#define Append_TVM_SETBKCOLOR         NULL
#define Append_TVM_SETTEXTCOLOR       NULL
#define Append_TVM_GETBKCOLOR         NULL
#define Append_TVM_GETTEXTCOLOR       NULL
#define Append_TVM_SETSCROLLTIME      NULL
#define Append_TVM_GETSCROLLTIME      NULL
#define Append_TVM_SETINSERTMARKCOLOR NULL
#define Append_TVM_GETINSERTMARKCOLOR NULL
#define Append_TVM_GETITEMSTATE       NULL
#define Append_TVM_SETLINECOLOR       NULL
#define Append_TVM_GETLINECOLOR       NULL
#define Append_TVM_INSERTITEMW        NULL
#define Append_TVM_GETITEMW           NULL
#define Append_TVM_SETITEMW           NULL
#define Append_TVM_GETISEARCHSTRINGW  NULL
#define Append_TVM_EDITLABELW         NULL
...
#ifdef _WIN32
//************************************************************************
//  Append_TVM_INSERTITEMA
//
//  Append message data
//************************************************************************

void Append_TVM_INSERTITEMA (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpis    ((LPTV_INSERTSTRUCTA) lParam)
    char szFlags1[64],
         szFlags2[64],
         szTVITEM[2048];
    ...
    wsprintf (lpsz,
              ...
              "hInsertAfter = %s, "
              "item = [%s] ",
              FormatFlags ((DWORD) lpis->hParent,      Flags_TVI, nFlags_TVI, szFlags1),
              FormatFlags ((DWORD) lpis->hInsertAfter, Flags_TVI, nFlags_TVI, szFlags2),
              Format_TVITEMA (&lpis->item, szTVITEM));
#undef lpis
} // End Append_TVM_INSERTITEMA ()
#endif
...
void Append_TVM_SETITEMA (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpi     ((LPTV_ITEMA) lParam)
         Format_TVITEMA (lpi, lpsz);
#undef lpi
} // End Append_TVM_SETITEMA ()
#endif
...
//  Format_WINDOWPOS ()
//
//  Format the WINDOWPOS data structure.
//************************************************************************

LPSTR Format_WINDOWPOS (LPWINDOWPOS lpwp, LPSTR lpsz)

{
    ...
    wsprintf (lpsz,
              ...
              "cy = %X, "
              "flags = %s",
              (HANDLE_WIDTH) lpwp->hwnd,
              (HANDLE_WIDTH) lpwp->hwndInsertAfter,
              lpwp->x,
              lpwp->y,
              lpwp->cx,
              lpwp->cy,
...
void Display_WINDOWPOS (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpwp        ((LPWINDOWPOS) lParam)
    Format_WINDOWPOS (lpwp, &lpsz[lstrlen (lpsz)]);

    OutputDebug (FormatStr (lpsz));
#undef lpwp
...
//  Display_RECT ()
//
//  Display RECT structure
//************************************************************************

void Display_RECT (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lprc        ((LPRECT) lParam)
    char szRECT[256];

    wsprintf (&lpsz[lstrlen (lpsz)],
              "rc = %s",
              Format_RECT (lprc, szRECT));
    OutputDebug (FormatStr (lpsz));
#undef lprc
} // End Display_RECT ()
...
void Display_DRAWITEMSTRUCT (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpdis   ((LPDRAWITEMSTRUCT) lParam)
    char szFlags1[256], szFlags2[256], szFlags3[256], szRect[80];
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              (HANDLE_WIDTH) lpdis->hwndItem,
              (HANDLE_WIDTH) lpdis->hDC,
...
void Display_Button (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              "Flags = %s",
              FormatFlags (GET_WM_COMMAND_CMD (wParam, lParam) + 0x80,
                           Flags_BN,
                           nFlags_BN,
                           szFlags));
    OutputDebug (FormatStr (lpsz));
...
void Display_ComboBox (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_EditBox (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_ListBox (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_ScrollBar (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_Static (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
//************************************************************************
//  Display_CREATESTRUCT ()
//
//  Display CREATESTRUCT structure
//************************************************************************

void Display_CREATESTRUCT (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpcs    ((LPCREATESTRUCT) lParam)
    char szFlags1[256], szFlags2[256];
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              lpcs->y,
              lpcs->x,
              FormatFlags (lpcs->style, Flags_WS, nFlags_WS, szFlags1),
              lpcs->lpszName,
              lpcs->lpszClass,
              FormatFlags (lpcs->dwExStyle, Flags_WS_EX, nFlags_WS_EX, szFlags2));
    OutputDebug (FormatStr (lpsz));

#undef  lpcs
} // End Display_CREATESTRUCT ()
...
//  Format_HDITEM ()
//
//  Format HDITEM structure
//************************************************************************

LPSTR Format_HDITEM (HWND hWnd, LPHDITEM lphdi, LPSTR lpsz)

{
#define lpnm        lphdi
    char szHDI[256], szHDF[256], szHDFT[256];
...
void Display_LV_DISPINFO (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_LV_FINDINFO (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_LV_KEYDOWN (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_CHAR (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_CLICK (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
    switch (clstr[LookupClass (((LPNMHDR) lParam)->hwndFrom)].eClass)
    {
        case EC_LISTVIEW:
            ...
            Display_NM_ITEMACTIVATE (lpsz, hWnd, wParam, lParam);
            break;

        case EC_STATUS:
            // Handle StatusBar as NMMOUSE
            Display_NM_MOUSE (lpsz, hWnd, wParam, lParam);
            break;
...
void Display_NM_CUSTOMDRAW_SUB (LPSTR lpsz,
                                LPARAM lParam,
...
#define lpnm        ((LPNMCUSTOMDRAW) lParam)
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              (LPSTR)(lpnm->dwDrawStage & CDDS_ITEM)?FormatFlags (lpnm->dwItemSpec, NULL, 0, szFlags2):NOTSEL,
              (LPSTR)(lpnm->dwDrawStage & CDDS_ITEM)?FormatFlags (lpnm->uItemState,  Flags_CDIS, nFlags_CDIS, szFlags3):NOTSEL,
              (LPSTR)(lpnm->dwDrawStage & CDDS_ITEM)?FormatFlags (lpnm->lItemlParam, NULL, 0, szFlags4):NOTSEL,
...
void Display_NM_CUSTOMDRAW (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
    switch (clstr[LookupClass (((LPNMHDR) lParam)->hwndFrom)].eClass)
    {
        case EC_LISTVIEW:
            ...
            Display_NM_LVCUSTOMDRAW (lpsz, lParam);
            break;

        case EC_TOOLBAR:
            // Handle ToolBar  as NMTBCUSTOMDRAW
            Display_NM_TBCUSTOMDRAW (lpsz, lParam);
            break;

        case EC_TOOLTIPS:
            // Handle ToolTip  as NMTTCUSTOMDRAW
            Display_NM_TTCUSTOMDRAW (lpsz, lParam);
            break;

        case EC_TREEVIEW:
            // Handle TreeView as NMTVCUSTOMDRAW
            Display_NM_TVCUSTOMDRAW (lpsz, lParam);
            break;
        default:
            // Handle all else as NMCUSTOMDRAW
            Display_NM_CUSTOMDRAW_SUB (lpsz, lParam, NULL);
            break;
    } // End SWITCH
...
void Display_NM_LVCUSTOMDRAW (LPSTR lpsz, LPARAM lParam)

{
    Display_NM_CUSTOMDRAW_SUB (lpsz, lParam, &Format_NM_LVCUSTOMDRAW);
...
void Display_NM_TBCUSTOMDRAW (LPSTR lpsz, LPARAM lParam)

{
    Display_NM_CUSTOMDRAW_SUB (lpsz, lParam, &Format_NM_TBCUSTOMDRAW);
...
void Display_NM_TTCUSTOMDRAW (LPSTR lpsz, LPARAM lParam)

{
    Display_NM_CUSTOMDRAW_SUB (lpsz, lParam, &Format_NM_TTCUSTOMDRAW);
...
void Display_NM_TVCUSTOMDRAW (LPSTR lpsz, LPARAM lParam)

{
    Display_NM_CUSTOMDRAW_SUB (lpsz, lParam, &Format_NM_TVCUSTOMDRAW);
...
void Display_NM_HEADER (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
#define lpnm        ((LPNMHEADER) lParam)
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              lpnm->iItem,
              lpnm->iButton,
              Format_HDITEM (hWnd, lpnm->pitem, szHDITEM));
    OutputDebug (FormatStr (lpsz));
#undef  lpnm
...
void Display_NM_ITEMACTIVATE (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpnm        ((LPNMITEMACTIVATE) lParam)
    char szLVIF[256], szLVKF[256], szPOINT[256];
...
void Display_NM_KEY (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_LISTVIEW (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpnm        ((LPNM_LISTVIEW) lParam)
    char szLVIF[256], szPOINT[256];
...
void Display_NM_MOUSE (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_RCLICK (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_RDBLCLK (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_TOOLTIPSCREATED (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NM_TREEVIEW (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpnm        ((LPNMTREEVIEW) lParam)
    char szPOINT[256], szTVITEM1[1024], szTVITEM2[1024];
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              "ptDrag = %s",
              lpnm->action,
              Format_TVITEMA (&lpnm->itemOld, szTVITEM1),
              Format_TVITEMA (&lpnm->itemNew, szTVITEM2),
...
void Display_NMHD_DISPINFO (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMHD_FILTERBTNCLICK (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMLV_CACHEHINT (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMLV_GETINFOTIP (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMLV_ODSTATECHANGED (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMTV_DISPINFO (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMTV_GETINFOTIP (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void Display_NMTV_KEYDOWN (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
//  Format_TVITEMA ()
//
//  Format TVITEMA structure
//************************************************************************

LPSTR Format_TVITEMA (LPTVITEMA lptvi, LPSTR lpsz)

{
    ...
    wsprintf (lpsz,
              ...
              "cChildren = %s, "
              "lParam = %s",
              FormatFlags (lptvi->mask,      Flags_TVIF,     nFlags_TVIF,     szFlags1),
              lptvi->hItem,
              (LPSTR) (lptvi->mask & TVIF_STATE)        ?FormatFlags (lptvi->state,     Flags_TVIS,     nFlags_TVIS,     szFlags2):NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_STATE)        ?FormatFlags (lptvi->stateMask, Flags_TVISmask, nFlags_TVISmask, szFlags3):NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_TEXT)         ?lptvi->pszText:NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_TEXT)         ?FormatFlags (lptvi->cchTextMax, NULL, 0, szFlags4):NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_IMAGE)        ?FormatFlags (lptvi->iImage, Flags_I_IMAGECALLBACK, nFlags_I_IMAGECALLBACK, szFlags5)        :NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_SELECTEDIMAGE)?FormatFlags (lptvi->iSelectedImage, Flags_I_IMAGECALLBACK, nFlags_I_IMAGECALLBACK, szFlags6):NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_CHILDREN)     ?FormatFlags (lptvi->cChildren, Flags_I_CHILDRENCALLBACK, nFlags_I_CHILDRENCALLBACK, szFlags7):NOTSEL,
              (LPSTR) (lptvi->mask & TVIF_PARAM)        ?FormatFlags (lptvi->lParam, NULL, 0, szFlags8):NOTSEL);
    return lpsz;
} // End Format_TVITEMA ()
#endif
...
//  Display_MINMAXINFO ()
//
//  Display the MINMAXINFO data structure.
//************************************************************************

void Display_MINMAXINFO (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
#define lpmmi       ((LPMINMAXINFO) lParam)
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              "ptMinTrackSize = %s, "
              "ptMaxTrackSize = %s",
              Format_POINT (lpmmi->ptReserved,     szPOINT1),
              Format_POINT (lpmmi->ptMaxSize,      szPOINT2),
              Format_POINT (lpmmi->ptMaxPosition,  szPOINT3),
              Format_POINT (lpmmi->ptMinTrackSize, szPOINT4),
              Format_POINT (lpmmi->ptMaxTrackSize, szPOINT5));
    OutputDebug (FormatStr (lpsz));
#undef lpmmi
} // End Display_MINMAXINFO ()


//************************************************************************
//  Display_NCCALCSIZE_PARAMS ()
//
//  Display the NCCALCSIZE_PARAMS data structure.
//************************************************************************

void Display_NCCALCSIZE_PARAMS (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpncsp      ((LPNCCALCSIZE_PARAMS) lParam)
    char szRect1[256],
         szRect2[256],
         szRect3[256],
         szWPos[1024];
    ...
    wsprintf (&lpsz[lstrlen (lpsz)],
              ...
              "rgrc[2] = %s, "
              "lppos = [%s]",
              Format_RECT (&lpncsp->rgrc[0], szRect1),
              Format_RECT (&lpncsp->rgrc[1], szRect2),
              Format_RECT (&lpncsp->rgrc[2], szRect3),
              Format_WINDOWPOS (lpncsp->lppos, szWPos));
    OutputDebug (FormatStr (lpsz));
#undef lpncsp
} // End Display_NCCALCSIZE_PARAMS ()
...
{
    static char szFmt[256];

    W2A (szFmt, lpwszText, sizeof (szFmt) - 1);
...
//  Display_REPLACESEL ()
//
//  Display the EM_REPLACESEL data structure.
//************************************************************************

void Display_REPLACESEL (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)

{
#define lpwszText   ((WCHAR *) lParam)

    wsprintf (&lpsz[lstrlen (lpsz)],
              "szText = \"%s\"",
              Format_TEXT (lpwszText));
    OutputDebug (FormatStr (lpsz));
#undef lpwszText
} // End Display_REPLACESEL ()
...
{
    char szL1[2048], szTemp[4096];
    void (*Display) (LPSTR, HWND, WPARAM, LPARAM) = NULL;
    ...
    if (Debug)
    {
        wsprintf (szL1,
                  ...
                  lpStr,
                  (WORD) hWnd,
                  APIMsg (hWnd, message, wParam, lParam, szTemp, TRUE));
        ...
        switch (message)
        {
            ...
            case WM_CREATE:             // lpcs = (LPCREATESTRUCT) lParam; // initialization data
            case WM_NCCREATE:           // lpcs = (LPCREATESTRUCT) lParam; // initialization data
                Display = Display_CREATESTRUCT;
                break;

            case WM_DRAWITEM:
                Display = Display_DRAWITEMSTRUCT;
                break;
...
#define lpnmh   ((LPNMHDR) lParam)
                ...
                wsprintf (&szL1[lstrlen (szL1)],
                          "hwndFrom = %04X%s, idFrom = %X, code = ",
                          (HANDLE_WIDTH) lpnmh->hwndFrom,
                          FormatClassName (lpnmh->hwndFrom),
                          lpnmh->idFrom);

#define CBEN(a) case CBEN_##a:                 \
                    lstrcat (szL1, "CBEN_" #a);\
                    break;
...
#define BCN(a)  case NMBC_##a:                 \
                    lstrcat (szL1, "NMBC_" #a);\
                    break;
...
#undef  lpnmh
            ...
            case WM_WINDOWPOSCHANGING:      // 0 = wParam
                                            // lpwp = (LPWINDOWPOS) lParam
                Display = Display_WINDOWPOS;

                break;

            case WM_GETMINMAXINFO:          // 0 wParam
                                            // lpmmi = (LPMINMAXINFO) lParam
                Display = Display_MINMAXINFO;

                break;

            case WM_NCCALCSIZE:             // fCalcValidRects = (BOOL) wParam
                                            // lpncsp = (LPNCCALCSIZE_PARAMS) lParam
                                            //   or
                                            // lpncsp = (LPRECT) lParam
                if (wParam)
                    Display = Display_NCCALCSIZE_PARAMS;
                else
                    Display = Display_RECT;
                break;

            case EM_REPLACESEL:
                    Display = Display_REPLACESEL;
                break;
        } // End SWITCH(message)

        if (Display)            // If there's a special display routine, ...
            (*Display) (szL1, hWnd, wParam, lParam);// Call it
        else
            OutputDebug (FormatStr (szL1));
    } // End IF
} // End ODSAPI ()
...
void DisplayText (LPSTR lpsz, HWND hWnd, WPARAM wParam, LPARAM lParam)
...
void OutputDebug (LPSTR lpsz)

{
    char *p, *q;

    // The argument consists of multiple lines separated
    //   by CR, LF
    // Split the argument into multiple calls to DbgMsg, one per line
